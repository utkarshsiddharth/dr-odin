                    ...
                    <div className="col-sm-6">
                      <div className="form-check switch-select">
                        ...
                        <input
                          ...
                          checked={
                            local_varaiable.dataVerticalStyle == "default" ||
                            local_varaiable.dataVerticalStyle == "overlay"
                          }
                    ...
                    <div className="col-sm-6">
                      <div className="form-check switch-select">
                        ...
                        <input
                          ...
                          name="sidemenu-layout-styles"
                          checked={
                            local_varaiable.toggled == "close-menu-close"
                          }
                          onChange={(_e) => {}}
                    ...
                    <div className="col-sm-6">
                      <div className="form-check switch-select">
                        ...
                        <input
                          ...
                          type="radio"
                          name="sidemenu-layout-styles"
                          checked={local_varaiable.toggled == "icon-text-close"}
                          onChange={(_e) => {}}
                    ...
                    <div className="col-sm-6">
                      <div className="form-check switch-select">
                        ...
                        <input
                          ...
                          onChange={(_e) => {}}
                          onClick={() =>
                            switcherdata.iconOverayFn(ThemeChanger)
                          }
                    ...
                    <div className="col-sm-6">
                      <div className="form-check switch-select">
                        ...
                        <input
                          ...
                          type="radio"
                          name="sidemenu-layout-styles"
                          checked={local_varaiable.toggled == "detached-close"}
                          onChange={(_e) => {}}
                    ...
                    <div className="col-4">
                      <div className="form-check switch-select">
                        ...
                        <input
                          ...
                          checked={local_varaiable.loader == "enable"}
                          onChange={(_e) => {}}
                          onClick={() => {
                            switcherdata.Enable(ThemeChanger);
                          }}
                        />
                      </div>
                    </div>
                    <div className="col-4">
                      <div className="form-check switch-select">
                        ...
                        <input
                          ...
                          type="radio"
                          name="page-loader"
                          checked={local_varaiable.loader == "disable"}
                          onChange={(_e) => {}}
                          onClick={() => {
                            switcherdata.Disable(ThemeChanger);
                          }}
