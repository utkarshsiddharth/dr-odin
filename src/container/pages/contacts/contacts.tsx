                  ...
                  <div className="d-flex mt-sm-0 mt-2 align-items-center">
                    ...
                    <Dropdown className="ms-2">
                      <Dropdown.Toggle
                        ...
                        className="btn btn-icon  btn-wave no-caret"
                        type="button"
              ...
              <Card.Body className="contact-action">
                ...
                <div className="d-flex align-items-top ">
                  <div className="d-flex flex-fill flex-wrap gap-2">
                    ...
                    <div>
                      <h6 className="mb-1 fw-semibold">{idx.name}</h6>
                  ...
                  <div>
                    <i
                      className={`ri-heart-3-${idx.class} fs-16 text-${idx.color}`}
                    ></i>
                  </div>
                </div>
                <div className="d-flex align-items-center justify-content-center gap-2 contact-hover-buttons">
                  ...
                  <Dropdown className="contact-hover-dropdown">
                    <Dropdown.Toggle
                      variant=""
                      className="btn btn-sm btn-icon btn-light btn-wave no-caret"
                      type="button"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                    >
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item href="#">
                        <i className="ri-phone-line me-2 align-middle d-inline-block"></i>
                        Call
                      </Dropdown.Item>
                      <Dropdown.Item href="#">
                        <i className="ri-chat-2-line me-2 align-middle d-inline-block"></i>
                        Message
                      </Dropdown.Item>
                      <Dropdown.Item href="#">
                        <i className="ri-video-chat-line me-2 align-middle d-inline-block"></i>
                        Video Call
                      </Dropdown.Item>
                      <Dropdown.Item href="#">
                        <i className="ri-delete-bin-5-line me-2 align-middle d-inline-block"></i>
                        Delete
                      </Dropdown.Item>
                      <Dropdown.Item href="#">
                        <i className="ri ri-heart-3-line me-2 align-middle d-inline-block"></i>
                        Favourite
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                  <Button
                    variant=""
                    aria-label="button"
                    className="btn btn-sm btn-icon btn-light contact-hover-dropdown1"
                    type="button"
                  >
            ...
            <Card.Body className="card-body contact-action">
              ...
              <div className="d-flex align-items-top">
                <div className="d-flex flex-fill flex-wrap gap-2">
                  ...
                  <div>
                    <h6 className="mb-1 fw-semibold">Shensovic Jeremy</h6>
                    <p className="mb-1 text-muted contact-mail text-truncate">
                      shensovicjeremy@gmail.com
                    </p>
                    <p className="fw-semibold fs-11 mb-0 text-primary">
                      +1(555) 238 2342
                    </p>
