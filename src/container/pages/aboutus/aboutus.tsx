                      ...
                      >
                        <div className="p-3 text-start mb-4">
                          <h6 className="fw-semibold text-fixed-white pb-4">
                            <span className="about-heading-white">
                              About Us
                            </span>
                          </h6>
                          <h3 className="fw-semibold mb-2 text-fixed-white">
                            DISCIPLINE IS WHAT{" "}
                            <span className="text-success">MOTIVATES</span>
                            YOU MOST
                          </h3>
                          <p className="mb-4 fw-normal op-7 fs-16">
                            You fight like a younger man, there’s nothing held
                            back. It’s admirable, but mistaken. When their
                            enemies were at the gates the Romans would suspend
                            democracy and appoint one man to protect the city...
                          </p>
                          <Button
                            variant=""
                          ...
                          <Card.Body className="card-body p-0">
                            <Row>
                              <Col
                                ...
                                md={4}
                                sm={4}
                                className="about-company-stats-border"
                              >
                        ...
                        <Card className="custom-card text-center">
                          ...
                          <Card.Footer>
                            <div className="btn-list">
                              ...
                              <Button
                                variant=""
                                className="btn btn-sm btn-icon btn-warning-light btn-wave"
                              >
