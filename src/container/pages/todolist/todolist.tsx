                  ...
                  <li>
                    <Link to="#">
                      <div className="d-flex align-items-center">
                        ...
                        <span className="flex-fill text-nowrap">Personal</span>
                      </div>
                    </Link>
                  </li>
                  <li>
                ...
                <Card className="custom-card">
                  <Card.Body className="card-body p-0">
                    <div className="d-flex p-3 align-items-center justify-content-between">
                      ...
                      <div>
                        <Nav
                          className="nav-tabs nav-tabs-header mb-0 d-sm-flex d-block"
                          role="tablist"
                        >
                      ...
                      <div>
                        <Dropdown>
                          <Dropdown.Toggle
                            variant=""
                            className="btn btn-icon btn-sm btn-light btn-wave waves-light waves-effect no-caret"
                            type="button"
                            ...
                            <div>
                              <div className="btn-list">
                                ...
                                <Button
                                  ...
                                  className="btn btn-sm btn-icon btn-wave  me-0"
                                >
