              ...
              <div className="p-4 border-bottom border-block-end-dashed">
                <div className="mb-4">
                  ...
                  <p className="fs-12 text-muted op-7 mb-0">
                    I am <b className="text-default">Sonya Taylor,</b> here by
                ...
                <div className="mb-0">
                  ...
                  <div className="mb-0">
                    <p className="mb-1">
                      <Link
                        to="https://www.spruko.com/"
                        className="text-primary"
                      >
                        <u>https://www.spruko.com/</u>
                      </Link>
                    </p>
                    <p className="mb-0">
                      <Link
              ...
              <div className="p-4 border-bottom border-block-end-dashed d-flex align-items-center">
                ...
                <div className="btn-list mb-0">
                  <Button
                    ...
                    className="btn btn-sm btn-icon  btn-wave waves-effect waves-light"
                  >
                ...
                <div>
                  {Skillsdata.map((idx) => (
                    <Link to="#" key={Math.random()}>
                      <span className="badge bg-light text-muted m-1">
                        {idx.text}
                      </span>
                    </Link>
                  ))}
                  ...
                  {Followersdata.map((idx) => (
                    <ListGroup.Item key={Math.random()}>
                      <div className="d-sm-flex align-items-top">
                        ...
                        <Button
                          variant=""
                          className="btn btn-light btn-wave btn-sm"
                        >
                          Follow
                        </Button>
                      </div>
                          ...
                          <ul className="list-unstyled profile-timeline">
                            <li>
                              <div>
                                ...
                                <p className="mb-2">
                                  <b>You</b> Commented on{" "}
                                  <b>alexander taylor</b> post{" "}
                            ...
                            <li>
                              <div>
                                ...
                                <p className="text-muted">
                                  you are already feeling the tense atmosphere
                                  of the video playing in the background
                                </p>
                                <p className="profile-activity-media mb-0">
                                  <Link to="#">
                            ...
                            <li>
                              <div>
                                ...
                                <p className="mb-1">
                                  <b>You</b> Commented on <b>Peter Engola</b>{" "}
                                  post{" "}
                                  <Link className="text-secondary" to="#">
                                    <u>#Mother Nature</u>
                                  </Link>
                              ...
                              <div className="d-sm-flex align-items-center lh-1">
                                ...
                                <div className="flex-fill me-sm-2 mt-1 mt-sm-0">
                                  <div className="input-group">
                                    ...
                                    <Button
                                      variant=""
                                      className="btn btn-light btn-wave d-none d-sm-block"
                                      type="button"
                                    >
                                      ...
                                      <div className="p-3 d-flex align-items-top flex-wrap">
                                          ...
                                          <div className="d-flex align-items-center justify-content-between mb-md-0 mb-2">
                                            <div>
                                              <div className="btn-list">
                                                ...
                                                <Button
                                                  variant=""
                                                  className="btn btn-icon btn-sm btn-danger-light btn-wave"
                                                >
                                        ...
                                        <div className="d-flex align-items-top">
                                          ...
                                          <Dropdown>
                                            <Dropdown.Toggle
                                              variant="light"
                                              className="btn btn-sm btn-icon  btn-wave no-caret"
                                              type="button"
                                      ...
                                      <div className="p-3 d-flex align-items-top flex-wrap">
                                        ...
                                        <div className="flex-fill">
                                          ...
                                          <p className="mb-3 profile-post-link">
                                            ...
                                            >
                                              <u>
                                                https://www.discovery.com/nature/caring-for-coral
                                              </u>
                                            </Link>
                                          </p>
                                          <div className="d-flex align-items-center justify-content-between mb-md-0 mb-2">
                                        ...
                                        <div className="d-flex align-items-top">
                                          <div>
                                            <span className="badge bg-secondary-transparent me-2">
                                              Travel
                                            </span>
                                          </div>
                                          <Dropdown>
                                        ...
                                        <div>
                                          <div className="d-flex align-items-top">
                                            ...
                                            <Dropdown>
                                              <Dropdown.Toggle
                                                variant="light"
                                                className="btn btn-sm btn-icon no-caret btn-wave"
                                                type="button"
                                                data-bs-toggle="dropdown"
                                                aria-expanded="false"
                                              >
                                  ...
                                  <Card.Body className="card-body p-4">
                                    <div className="text-center">
                                      ...
                                      <div className="mt-2">
                                        ...
                                        <p className="fs-12 op-7 mb-1 text-muted">
                                          {idx.mail}
                                        </p>
                                        <Badge
                                          bg={idx.color}
                    ...
                    {Personalinfodata.map((idx) => (
                      <ListGroup.Item key={Math.random()}>
                        <div className="d-flex flex-wrap align-items-center">
                          <div className="me-2 fw-semibold">{idx.text1}</div>
                        ...
                        <Link to="#">
                          <div className="d-flex flex-wrap align-items-center">
                            ...
                            <div className="flex-fill">
                              ...
                              <p className="mb-1 fs-12 profile-recent-posts text-truncate text-muted">
                                {idx.text}
                              </p>
                            </div>
                          </div>
              ...
              <Card className="custom-card">
                <Card.Header className="card-header d-flex justify-content-between">
                  ...
                  <div>
                    <Button
                      variant=""
                      className="btn btn-sm btn-success-light btn-wave"
                    >
                      View All
                    </Button>
                  </div>
