import { FC, Fragment, useState, useRef, ChangeEvent } from "react";
import {
  Card,
  Col,
  Dropdown,
                ...
                <Card.Header className="card-header d-sm-flex d-block">
                  ...
                  >
                    <Nav.Item className="m-1">
                      <Nav.Link eventKey="one" href="#personal-info">
                        Personal Information
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item className="m-1">
                      <Nav.Link eventKey="two" href="#account-settings">
                        Account Settings
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item className="m-1">
                      <Nav.Link eventKey="three" href="#email-settings">
                        Email
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item className="m-1">
                      <Nav.Link eventKey="four" href="#labels">
                        Labels
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item className="m-1">
                      <Nav.Link eventKey="five" href="#notification-settings">
                        Notifications
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item className="m-1">
                      <Nav.Link eventKey="six" href="#security">
                        Security
                      </Nav.Link>
                    </Nav.Item>
                  </Nav>
                  ...
                  <Tab.Content>
                    ...
                    >
                      <div className="p-sm-3 p-0">
                        <h6 className="fw-semibold mb-3">Photo :</h6>
                        ...
                        <div className="row gy-4 mb-4">
                          ...
                          <Col xl={6}>
                            <Form.Label htmlFor="Contact-Details" className="">
                              Contact Details :
                            </Form.Label>
                            <Form.Control
                              type="text"
                            ...
                            <Card.Body>
                              ...
                              <div className="d-sm-flex d-block align-items-top mb-4 justify-content-between">
                                <div className="mb-sm-0 mb-2">
                                  <p className="fs-14 mb-2 fw-semibold">
                                    Authentication
                                  </p>
                                  <div className="mb-0">
                                    <div
                                    ...
                                    >
                                      ...
                                      <label
                                        ...
                                        htmlFor="btnradio1"
                                      >
                                        <i className="ri-lock-unlock-line me-1 align-middle d-inline-block"></i>
                                        Pin
                                      </label>
                                      <input
                                        type="radio"
                                      ...
                                      <label
                                        ...
                                        htmlFor="btnradio2"
                                      >
                                        <i className="ri-lock-password-line me-1 align-middle d-inline-block"></i>
                                        Password
                                      </label>
                                      <input
                                        type="radio"
                                      ...
                                      <label
                                        ...
                                        htmlFor="btnradio3"
                                      >
                                        <i className="ri-fingerprint-line me-1 align-middle d-inline-block"></i>
                                        Finger Print
                                      </label>
                                    </div>
                                  </div>
                              ...
                              <div className="d-sm-flex d-block align-items-top mb-4 justify-content-between">
                                <div>
                                  ...
                                  <p className="fs-12 text-muted mb-0">
                                    Incase of forgetting password mails are sent
                                    to heifo@gmail.com
                                  </p>
                                </div>
                                <div className="custom-toggle-switch ms-sm-2 ms-0">
                              ...
                              <div className="d-sm-flex d-block align-items-top mb-4 justify-content-between">
                                <div>
                                  ...
                                  <p className="fs-12 text-muted mb-0">
                                    SMS are sent to 9102312xx in case of
                                    recovery
                                  </p>
                                </div>
                                <div className="custom-toggle-switch ms-sm-2 ms-0">
                      ...
                      <ul className="list-group list-group-flush list-unstyled rounded">
                        <ListGroup.Item>
                          <div className="row gx-5 gy-3">
                            <Col xl={5}>
                              <p className="fs-16 mb-1 fw-semibold">
                                Email Notifications
                              </p>
                              <p className="fs-12 mb-0 text-muted">
                                Email notifications are the notifications you
                                will receeive when you are offline, you can
                                customize them by enabling or disabling them.
                              </p>
                            </Col>
                            <Col xl={7}>
                              ...
                              <div className="d-flex align-items-top justify-content-between mt-3">
                                <div className="mail-notification-settings">
                                  ...
                                  <p className="fs-12 mb-0 text-muted">
                                    ...
                                    update,notifications relating or participate
                                    in any of paid product promotion.
                                  </p>
                                </div>
                                <div>
                                  <div className="custom-toggle-switch float-sm-end">
                              ...
                              <div className="d-flex align-items-top justify-content-between mt-3">
                                <div className="mail-notification-settings">
                                  ...
                                  <p className="fs-12 mb-0 text-muted">
                                    Any of new messages are received will be
                        ...
                        <ListGroup.Item>
                          <div className="row gx-5 gy-3">
                            <Col xl={5}>
                              ...
                              <p className="fs-12 mb-0 text-muted">
                                Push notifications are recieved when you are
                                online, you can customize them by enabling or
                                disabling them.
                              </p>
                            </Col>
                            <Col xl={7}>
                              ...
                              <div className="d-flex align-items-top justify-content-between mt-3">
                                <div className="mail-notification-settings">
                                  ...
                                  <p className="fs-12 mb-0 text-muted">
                                    Notifications related to the extensions
                                    received by new emails and thier propertied
                                    also been displayed.
                                  </p>
                                </div>
                                <div>
                        ...
                        <ListGroup.Item>
                          <div className="row gx-5 gy-3">
                            <Col xl={4}>
                              ...
                              <p className="fs-12 mb-0 text-muted">
                                Security settings related to logging into our
                                email account and taking down account if any
                                mischevious action happended.
                              </p>
                            </Col>
                            <Col xl={8}>
                              <div className="d-sm-flex d-block align-items-top justify-content-between mt-sm-0 mt-3">
                                <div className="mail-security-settings">
                                  ...
                                  <p className="fs-12 mb-0 text-muted">
                                    Account will freeze for 24hrs while attempt
                                    to login with wrong credentials for selected
                                    number of times
                                  </p>
                                </div>
                                <div>
                                  <Select
                                    name="colors"
                                    options={MaxLimitoptions}
                                    className="basic-multi-select"
                                    menuPlacement="auto"
                                    classNamePrefix="Select2"
                                    defaultValue={[MaxLimitoptions[0]]}
                                  />
                                </div>
                              </div>
                              <div className="d-sm-flex d-block align-items-top justify-content-between mt-3">
                                <div>
                                  ...
                                  <p className="fs-12 mb-0 text-muted">
                                    You can change the time for the account
                                    freeze when attempts for{" "}
                                  </p>
                                </div>
                                <div>
                                  <Select
                          ...
                          <div className="row gx-5 gy-3">
                            ...
                            <Col xl={8}>
                              <div className="d-sm-flex d-block align-items-top justify-content-between mt-sm-0 mt-3">
                                <div className="mail-security-settings">
                                  <p className="fs-14 mb-1 fw-semibold">
                                    Minimun number of characters in the password
                                  </p>
                                  <p className="fs-12 mb-0 text-muted">
                                    There should be a minimum number of
                                    characters for a password to be validated
                              ...
                              <div className="d-sm-flex d-block align-items-top justify-content-between mt-3">
                                <div>
                                  <p className="fs-14 mb-1 fw-semibold">
                                    Maximun Password Length
                                  </p>
                                  <p className="fs-12 mb-0 text-muted">
                                    Maximum password lenth should be selected
                                    here.
                                  </p>
                                </div>
                                <div>
