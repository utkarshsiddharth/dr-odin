    ...
    <Fragment>
      <div className="file-manager-container p-2 gap-2 d-sm-flex">
          ...
          <div className="d-flex align-items-center justify-content-between w-100 p-3 border-bottom">
            ...
            <Dropdown>
              <Dropdown.Toggle
                ...
                className="btn btn-sm btn-icon no-caret btn-wave waves-light"
                type="button"
              >
                ...
                <li className="d-flex align-items-center justify-content-center">
                  <div className="filemanager-upgrade-storage">
                    ...
                    <div className="mt-3 d-grid">
                      <Button variant="" className="btn btn-primary-gradient">
                        Upgrade
                      </Button>
                    </div>
                  </div>
        ...
        <div className="file-manager-folders">
          <div className="d-flex p-3 flex-wrap gap-2 align-items-center justify-content-between border-bottom">
            ...
            <div className="d-flex gap-2">
              ...
              <Button
                ...
                onClick={handleShow}
              >
                <i className="ri-add-circle-line align-middle me-1"></i>Create
                Folder
              </Button>
              <Modal
                centered
              ...
              >
                ...
                <Modal.Body className="">
                  <Form.Label htmlFor="create-folder1" className="form-label">
                    Folder Name
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <div className="modal-dialog modal-dialog-centered">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      <Form.Label htmlFor="create-file1" className="form-label">
                        File Name
                      </Form.Label>
                      <Form.Control
                        type="text"
          ...
          <div
            className="p-3 file-folders-container overflow-scroll"
                    ...
                    <Card.Body className="card-body p-3">
                      <Link to="#">
                        <div className="d-flex justify-content-between flex-wrap">
                          <div className="file-format-icon">{idx.class}</div>
                          <div>
          ...
          <div className="d-flex p-3 align-items-center justify-content-between border-bottom">
            ...
            <div className="d-flex align-items-center">
              <Dropdown className="dropdown me-1">
                <Dropdown.Toggle
                  variant="primary-light"
                  className="btn btn-sm btn-icon no-caret btn-wave waves-light waves-effect waves-light"
                  type="button"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
                ...
                <ListGroup.Item>
                  <div>
                    ...
                    <span className="fs-12 text-muted">
                      ...
                      ynex.featured and 42 images and layout styles are added in
                      this update.
                    </span>
                  </div>
                </ListGroup.Item>
