      ...
      <div className="main-chart-wrapper p-2 gap-2 d-lg-flex">
        <div className="chat-info border">
          ...
          <Tab.Container defaultActiveKey="first">
            <Nav
              className="nav nav-tabs tab-style-2 nav-justified mb-0 border-bottom d-flex"
              id="myTab1"
              role="tablist"
            ...
            >
              <Nav.Item className="nav-item border-end me-0">
                <Nav.Link href="#" eventKey="first" className="h-100">
                  <i className="ri-history-line me-1 align-middle d-inline-block"></i>
                  Recent
                </Nav.Link>
              </Nav.Item>
              <Nav.Item className="nav-item border-end me-0">
                <Nav.Link className="h-100" href="#" eventKey="second">
                  <i className="ri-group-2-line me-1 align-middle d-inline-block"></i>
                  Groups
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link href="#" className="h-100" eventKey="third">
                  <i className="ri-phone-line me-1 align-middle d-inline-block"></i>
                  Calls
                </Nav.Link>
              </Nav.Item>
            </Nav>
            <Tab.Content>
                        ...
                        <div className="d-flex align-items-top">
                          ...
                          <div className="flex-fill">
                            ...
                            <p className="fs-12 mb-0 chat-msg-typing ">
                              ...
                              <span className="badge bg-success-transparent rounded-circle float-end">
                                2
                              </span>
                            </p>
                          </div>
                      ...
                      >
                        <div className="d-flex align-items-top">
                          ...
                          <div className="flex-fill">
                            ...
                            <p className="fs-12 mb-0">
                              <span className="chat-msg text-truncate">
                                You are need to be appreaciated for what you
                                have done,congs
                              </span>
                              <span className="chat-read-icon float-end align-middle">
                                <i className="ri-check-double-fill"></i>
              ...
              <Tab.Pane
                className="border-0 chat-groups-tab"
                eventKey="second"
                id="groups-tab-pane"
              >
                <PerfectScrollbar>
                  <ul className="list-unstyled mb-0 mt-2 chat-groups-tab">
                    <li className="pb-0">
                      <p className="text-muted fs-11 fw-semibold mb-1 op-7">
                        MY CHAT GROUPS
                      </p>
                    </li>
                    <li>
                      ...
                      >
                        <div className="d-flex align-items-top">
                          ...
                          <div className="flex-fill">
                            ...
                            <p className="fs-12 mb-0">
                              <span className="chat-msg text-truncate">
                                <span className="group-indivudial">Rams:</span>
                      ...
                      >
                        <div className="d-flex align-items-top">
                          ...
                          <div className="flex-fill">
                            ...
                            <p className="fs-12 mb-0">
                              <span className="chat-msg text-truncate">
                                Simon,Melissa,Amanda,Patrick,Siddique
                              </span>
                              <span className="chat-read-icon float-end align-middle">
                                <i className="ri-check-double-fill"></i>
                              </span>
                      ...
                      >
                        <div className="d-flex align-items-top">
                          ...
                          <div className="flex-fill">
                            ...
                            <p className="fs-12 mb-0">
                              <span className="chat-msg text-truncate">
                                Kamalan,Subha,Ambrose,Kiara,Jackson
                              </span>
                              <span className="chat-read-icon float-end align-middle">
                                <i className="ri-check-double-fill"></i>
                              </span>
                      ...
                      >
                        <div className="d-flex align-items-top">
                          ...
                          <div className="flex-fill">
                            ...
                            <p className="fs-12 mb-0">
                              <span className="chat-msg text-truncate">
                                Subman,Rajen,Kairo,Dibasha,Alexa
                              </span>
                              <span className="chat-read-icon float-end align-middle">
                                <i className="ri-check-double-fill"></i>
                              </span>
              ...
              <Tab.Pane
                className="tab-pane fade border-0 chat-calls-tab"
                id="calls-tab-pane"
                eventKey="third"
              >
                <PerfectScrollbar>
                    ...
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-fill my-auto">
                          <p className="mb-0 fw-semibold">
                            Sujika
                            <span className="ms-1 incoming-call-success">
                    ...
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-fill my-auto">
                          <p className="mb-0 fw-semibold">
                            Melissa
                            <span className="ms-1 outgoing-call-failed">
                    ...
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-fill my-auto">
                          <p className="mb-0 fw-semibold">
                            Sharukh Sam
                            <span className="ms-1 outgoing-call-success">
                              <i className="ti ti-arrow-up-right"></i>
                            </span>
                          </p>
                          <p className="fs-12 mb-0">
                    ...
                    <li>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-fill my-auto">
                          <p className="mb-0 fw-semibold">
                            Azimo Peter
                            <span className="ms-1 incoming-call-failed">
                              <i className="ti ti-arrow-up-right"></i>
                            </span>
                          </p>
                          <p className="fs-12 mb-0">
        ...
        <div className="main-chat-area border">
          <div className="d-flex align-items-center p-2 border-bottom">
            ...
            <div className="d-flex">
              ...
              <Button
                ...
                aria-label="button"
                type="button"
                className="btn btn-icon ms-2 responsive-userinfo-open"
              >
              ...
              <Button
                ...
                aria-label="button"
                type="button"
                className="btn btn-icon ms-2 responsive-chat-close"
              >
                      ...
                      <div className="main-chat-msg">
                        ...
                        <div>
                          <p className="mb-0 d-sm-flex d-block">
                            <Link
                              aria-label="anchor"
                              to={`${import.meta.env.BASE_URL}apps/gallery/`}
          ...
          <div className="chat-footer">
            ...
            <Link
              aria-label="anchor"
              className="btn btn-icon mx-2 btn-success-light"
              to="#"
            >
        ...
        <PerfectScrollbar className="chat-user-details border">
          <div className="text-center mb-5">
            <span className="avatar avatar-rounded online avatar-xxl mt-2 mb-3 chatstatusperson">
              <img className="chatimageperson" src={face2} alt="img" />
            </span>
            <p className="mb-1 fs-15 fw-semibold text-dark lh-1 chatnameperson">
              Emiley Jackson
            </p>
            <p className="fs-12 text-muted">
              <span className="chatnameperson">emaileyjackson2134</span>
              @gmail.com
            </p>
            <p className="text-center mb-0">
              <Button
                ...
                type="button"
                aria-label="button"
                className="btn btn-icon rounded-pill btn-primary-light"
              >
              ...
              <Button
                ...
                type="button"
                aria-label="button"
                className="btn btn-icon rounded-pill btn-primary-light ms-2"
              >
          ...
          <div className="mb-5">
            <div className="fw-semibold mb-4">
              Shared Files
              <span className="badge bg-primary-transparent rounded-circle ms-1">
                4
              </span>
              <span className="float-end fs-11">
                <Link to="#" className="link-primary text-underline">
                  <u>View All</u>
                </Link>
              </span>
            </div>
