          ...
          <Card className="custom-card">
            <Card.Body className="add-products p-0">
                    ...
                    <Card className="custom-card shadow-none mb-0 border-0">
                      <Card.Body className="card-body p-0">
                        <Row className="row gy-4">
                          ...
                          <Form.Label className="form-label op-5 mt-3">
                            Minimum 0f 6 images are need to be uploaded,make
                            sure the image size match the proper background size
                            and all images should be uniformly maintained with
                            width and height to the image container,image size
                            should not exceed 2MB,once uploaded to change the
                            image you need to wait minimum of 24hrs.{" "}
                          </Form.Label>
                          <Col xl={12} className="product-documents-container">
                            <p className="fw-semibold mb-2 fs-14">
                              Warrenty Documents :
              ...
              <div className="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-end">
                <Button variant="" className="btn btn-primary-light m-1">
