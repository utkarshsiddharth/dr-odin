  ...
  render() {
    return (
      <Wizard step={this.state.step} onChange={this.handleStep}>
        {/* <i className="ri-truck-line me-2 align-middle"></i> */}
            ...
            <div className="p-4">
              ...
              <div className="fs-15 fw-semibold d-sm-flex d-block align-items-center justify-content-between mb-3">
                ...
                <div className="mt-sm-0 mt-2">
                  ...
                  >
                    <i className="ri-add-line me-1 align-middle fs-14 fw-semibold d-inline-block"></i>
                    Add New Address
                  </Button>
                  <Modal
                    centered
              ...
              <div className="row gy-4 mb-4">
                ...
                <Col xl={6}>
                  ...
                  <Form.Check
                    ...
                    isValid
                    defaultChecked
                    className="form-checked-outline form-checked-success mt-1 text-success"
                  ...
                  <div className="form-check shipping-method-container mb-0">
                    ...
                    <div className="form-check-label">
                      <div className="d-sm-flex align-items-center justify-content-between">
                        ...
                        <div className="fw-semibold me-sm-5 me-0">$9.99</div>
                      </div>
                    </div>
                  </div>
                </Col>
                    ...
                    <div className="form-check-label">
                      <div className="d-sm-flex align-items-center justify-content-between">
                        ...
                        <div className="shipping-partner-details me-sm-5 me-0">
                          ...
                          <p className="text-muted fs-11 mb-0">
                            Delivered By 22,Nov 2022
                          </p>
                        </div>
                        <div className="fw-semibold me-sm-5 me-0">$10.49</div>
                      </div>
                    </div>
                  </div>
                </Col>
                  ...
                  <div className="form-check shipping-method-container mb-0">
                    ...
                    <div className="form-check-label">
                      <div className="d-sm-flex align-items-center justify-content-between">
                        ...
                        <div className="fw-semibold me-sm-5 me-0">$12.29</div>
                      </div>
                    </div>
                  </div>
                </Col>
                  ...
                  <div className="form-check shipping-method-container mb-0">
                    ...
                    <div className="form-check-label">
                      <div className="d-sm-flex align-items-center justify-content-between">
                        ...
                        <div className="fw-semibold me-sm-5 me-0">$18.99</div>
                      </div>
                    </div>
                  </div>
                </Col>
          ...
          <section className="card-body Basicwizard p-0 ">
            <div className="p-4">
              ...
              <div className="row gy-4">
                ...
                <Col xl={6}>
                  <Form.Label htmlFor="email-personal" className="form-label">
                    Email
                  </Form.Label>
                  <Form.Control
                    type="email"
                ...
                <Col xl={6}>
                  <Form.Label htmlFor="phoneno-personal" className="form-label">
                    Phone no
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <Col xxl={2}>
                  <Form.Label htmlFor="pincode-personal" className="form-label">
                    Pincode
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <Col xxl={2}>
                  <Form.Label htmlFor="country-personal" className="form-label">
                    Country
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <Col xl={12}>
                  ...
                  <div className="form-check mt-1">
                    <input
                      className="form-check-input form-checked-outline form-checked-success"
                      type="checkbox"
                      defaultValue=""
                      id="invalidCheck1"
                      required
                    ...
                    />
                    <Form.Label
                      className="form-check-label text-success fs-12"
              ...
              <Row>
                <Col xl={12}>
                  <div className="mb-3">
                    ...
                    <div className="input-group">
                      ...
                      <Button
                        variant=""
                        type="button"
                        className="btn btn-info-light input-group-text"
                        id="payment-address"
                      >
                        Change
                      </Button>
                  ...
                  <Card className="custom-card border shadow-none mb-3">
                    ...
                    <Card.Body>
                      <div
                        className="btn-group mb-3 d-sm-flex d-block"
                        role="group"
                      ...
                      >
                        ...
                        />
                        <Form.Label
                          className="btn btn-outline-light text-default"
                          htmlFor="btnradio1"
                        >
                        ...
                        />
                        <Form.Label
                          className="btn btn-outline-light text-default mt-sm-0 mt-1"
                          htmlFor="btnradio2"
                        >
                          UPI
                        </Form.Label>
                      ...
                      <div className="row gy-3">
                        ...
                        <Col xl={4}>
                          ...
                          <Form.Label
                            htmlFor="payment-security"
                            className="form-label mt-1 text-success fs-11"
                          >
                            <sup>
