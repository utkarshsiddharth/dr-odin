          ...
          <div className="row justify-content-center">
            <Col xl={6}>
              <div className="text-center p-3 faq-header mb-4">
                ...
                <p className="fs-15 text-muted op-7">
          ...
          <Row>
            <Col xl={6}>
              <Card className="custom-card">
                ...
                <Card.Body>
                  <Accordion
                    className="accordion accordion-customicon1 accordion-primary"
                    id="accordionFAQ1"
                    defaultActiveKey="0"
                  >
              ...
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title className="lh-base">
                    ...
                    <span className="subtitle fw-normal text-muted d-block fs-12">
                      You can post your questions here,our support team is
                      always active.
                    </span>
                  </Card.Title>
                </Card.Header>
                <Card.Body>
                  <div className="row gy-3">
                    <Col xl={6}>
                      <Form.Label htmlFor="user-name" className="form-label">
                        Your Name
                      </Form.Label>
                      <Form.Control
                        type="text"
                    ...
                    <Col xl={6}>
                      <Form.Label htmlFor="user-email" className="form-label">
                        Email Id
                      </Form.Label>
                      <Form.Control
                        type="text"
                ...
                <Card.Footer>
                  <Button variant="primary" className="btn  btn-wave float-end">
                    Send
                  </Button>
                </Card.Footer>
              </Card>
