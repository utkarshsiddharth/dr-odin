          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              <Form.Floating className="mb-3">
                ...
                />
                <Form.Label htmlFor="floatingEmptyPlaintextInput">
                  Empty input
                </Form.Label>
              </Form.Floating>
              <Form.Floating className="">
                ...
                />
                <Form.Label htmlFor="floatingPlaintextInput">
                  Input with value
                </Form.Label>
              </Form.Floating>
            </Card.Body>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Floating Labels With Pre Defined Values</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              ...
              <div className="form-flotin">
                <Form.Control
                  ...
                  defaultValue="test@example.com"
                />
                <Form.Label htmlFor="floatingInputInvalid">
                  Invalid input
                </Form.Label>
              </div>
            </Card.Body>
            <Collapse in={open3} className="card-body">
              <pre>
                <code>{`<Form.Floating className="my-3">
...
<Form.Label htmlFor="floatingInputInvalid">Invalid input</Form.Label>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Textareas</Card.Title>
              <div className="prism-toggle">
                <Button
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <div className="card-header justify-content-between">
              <Card.Title>Floating Labels In Select</Card.Title>
              <div className="prism-toggle">
                <Button
  ...
  <Form.Select aria-label="Floating label select example">
      ...
      <option value="3">Three</option>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Floating Labels With Layouts</Card.Title>
              <div className="prism-toggle">
                <Button
              ...
              <div className="row g-2">
                <div className="col-md">
                  <Form.Floating className="">
                    ...
                    />
                    <Form.Label htmlFor="floatingInputGrid">
                      Email address
                    </Form.Label>
                  </Form.Floating>
                </div>
                ...
                <Col xl={4} className="">
                  <Form.Floating className="mb-4 floating-primary">
                    <Form.Control
                      ...
                      placeholder="name@example.com"
                    />
                    <Form.Label htmlFor="floatingInputprimary">
                      primary
                    </Form.Label>
                  </Form.Floating>
                </Col>
                <Col xl={4} className="">
                  <Form.Floating className="mb-4 floating-secondary">
                    <Form.Control
                      ...
                      placeholder="name@example.com"
                    />
                    <Form.Label htmlFor="floatingInputsecondary">
                      secondary
                    </Form.Label>
                  </Form.Floating>
                </Col>
                <Col xl={4} className="">
                  <Form.Floating className="mb-4 floating-warning">
                    <Form.Control
                      ...
                      placeholder="name@example.com"
                    />
                    <Form.Label htmlFor="floatingInputwarning">
                      warning
                    </Form.Label>
                  </Form.Floating>
                </Col>
                ...
                <Col xl={4} className="">
                  <Form.Floating className="mb-4 floating-success">
                    <Form.Control
                      ...
                      placeholder="name@example.com"
                    />
                    <Form.Label htmlFor="floatingInputsuccess">
                      success
                    </Form.Label>
                  </Form.Floating>
                </Col>
                <Col xl={4} className="">
                  <Form.Floating className="mb-4 floating-danger">
                    <Form.Control
                      ...
                      placeholder="name@example.com"
                    />
                    <Form.Label htmlFor="floatingInputdanger">
                      danger
                    </Form.Label>
                  </Form.Floating>
                </Col>
