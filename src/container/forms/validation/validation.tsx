...
function FormExample() {
  ...
  export default FormExample;`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
            ...
            <Card.Body>
              <Form className="row g-3">
                ...
                <Col md={4}>
                  ...
                  <InputGroup>
                    <InputGroup.Text className="" id="inputGroupPrepend2">
                      @
                    </InputGroup.Text>
                    <Form.Control
                      type="text"
            ...
            <Card.Body>
              <Form className="was-validated">
                ...
                <Form.Check
                  ...
                  feedback="More example invalid feedback textt"
                  feedbackType="invalid"
                />
                <Form.Group className="mb-3">
                  <Form.Select
