        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Vertical Forms</Card.Title>
            ...
            <Card.Body>
              <div className="mb-3">
                <Form.Label htmlFor="form-text" className=" fs-14 text-dark">
                  Enter name
                </Form.Label>
                <Form.Control
                  type="text"
              ...
              <div className="mb-3">
                <Form.Label htmlFor="form-password" className="fs-14 text-dark">
                  Enter Password
                </Form.Label>
                <Form.Control
                  type="password"
...
<Form.Check className="" type="checkbox" value="" id="invalidCheck" label="Accept Policy"
     required/>
<Button variant='primary' className="" type="submit">Submit</Button>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
...
<Button variant='primary' className="" type="submit">Submit</Button>`}</code>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Vertical Forms with icon</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <div className="mb-3">
                <Form.Label htmlFor="form-text1" className="fs-14 text-dark">
                  Enter name
                </Form.Label>
                <InputGroup>
 ...
 <InputGroup>
     ...
     <Form.Control type="password" className="" id="form-password1" placeholder=""/>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Horizontal form With Icons</Card.Title>
              <div className="prism-toggle">
                <Button
 ...
 <Button variant='' type="submit" className="btn btn-primary">Sign in</Button>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Inline forms</Card.Title>
              <div className="prism-toggle">
                <Button
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <div className="mb-3">
                <Form.Label htmlFor="formGroupExampleInput" className="">
                  Example label
                </Form.Label>
                <Form.Control
                  type="text"
              ...
              <div className="mb-1">
                <Form.Label htmlFor="formGroupExampleInput2" className="">
                  Another label
                </Form.Label>
                <Form.Control
                  type="text"
          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              <Form className="row g-3 mt-0">
                ...
                <Col md={6}>
                  <Form.Label htmlFor="inputEmail4" className="">
                    Email
                  </Form.Label>
                  <Form.Control type="email" className="" id="inputEmail4" />
                </Col>
                <Col md={6}>
                  <Form.Label htmlFor="inputPassword4" className="">
                    Password
                  </Form.Label>
                  <Form.Control
                    type="password"
                ...
                <div className="col-12">
                  <Form.Label htmlFor="inputAddress" className="">
                    Address
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <div className="col-12">
                  <Form.Label htmlFor="inputAddress2" className="">
                    Address 2
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <Col md={6}>
                  <Form.Label htmlFor="inputCity" className="">
                    City
                  </Form.Label>
                  <Form.Control type="text" className="" id="inputCity" />
                </Col>
                <Col md={4}>
                  <Form.Label htmlFor="inputState" className="">
                    State
                  </Form.Label>
                ...
                <Col md={2}>
                  <Form.Label htmlFor="inputZip" className="">
                    Zip
                  </Form.Label>
                  <Form.Control
                    type="text"
