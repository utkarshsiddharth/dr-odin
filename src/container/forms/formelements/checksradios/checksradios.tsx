...
const Checksradios: FC<ChecksradiosProps> = () => {
 ...
 <Form.Check disabled defaultChecked
  label="Disabled checked checkbox"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
...
label="Default checked radio"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
 ...
 label="Default checked radio"/>`}</code>
      ...
      <Row>
        <Col xl={6} lg={6} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Default (stacked)</Card.Title>
              <div className="prism-toggle">
                <Button
...
<Form.Check disabled  label="Default checkbox"/>
<Form.Check type="radio"  label="Default checkbox"/>
<Form.Check type="radio" disabled  label="Default checkbox"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
...
<Form.Check type="switch" disabled defaultChecked  label="Default switch checkbox input"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
      ...
      <Row>
        <Col xxl={4} xl={12} lg={12} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Checkbox Sizes</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body className="d-sm-flex align-items-center justify-content-between">
              ...
              />
              <Form.Check
                className="form-check-lg d-flex align-items-center"
                type="checkbox"
                defaultChecked
                id="checkebox-lg"
                label="Large"
...
type="checkbox" defaultChecked id="checkebox-lg"  label="Large"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
 ...
 <Form.Check type="radio" className="form-check-lg" 
  defaultChecked id="Radio-lg"  label="Large"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
        <Col xxl={4} xl={12} lg={12} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Switch Sizes</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body className=" d-sm-flex align-item-center justify-content-between">
              ...
              <Form.Check
                type="switch"
                className="form-check-md form-switch"
                id="switch-md"
                label="Medium"
              />
              <Form.Check
 ...
 <Form.Check type="switch" className="form-check-lg form-switch" 
  defaultChecked id="switch-lg"  label="Large"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
...
<span><Form.Check className="" type="radio" /></span>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
 ...
 className="form-check-reverse mb-3" 
 type="switch" 
 label="Reverse switch checkbox input" />`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
        <Col xl={3} lg={12} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Outlined styles</Card.Title>
              <div className="prism-toggle">
                <Button
 ...
 >Danger radio</Button>`}</code>
      ...
      <Row>
        <Col xl={6} lg={12} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Radio toggle buttons</Card.Title>
              <div className="prism-toggle">
                <Button
...
<Form.Check type="radio" className="btn-check" name="options" 
id="option4"/>
<Button className="btn btn-primary m-1">Radio</Button>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
        <Col xl={6} lg={12} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Checkbox toggle buttons</Card.Title>
              <div className="prism-toggle">
                <Button
...
<Button disabled className="btn btn-primary m-1">Disabled</Button>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
      ...
      <Row className="row row-cols-12">
        <Col>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Colored Checkboxes</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              {Checkdata1.map((idx) => (
                <div className={`form-check ${idx.class1}`} key={Math.random()}>
                  <input
                    id={idx.id}
                    className={`form-check-input form-checked-${idx.class2}`}
                    type="checkbox"
                    defaultChecked
                  />
...
<label className="form-check-label" htmlFor="primaryChecked">
    info
        ...
        <Col>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Outline Checkboxes</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              {Checkdata1.map((idx) => (
                <div className={`form-check ${idx.class1}`} key={Math.random()}>
                  <input
                    id={idx.id}
                    className={`form-check-input form-checked-outline form-checked-${idx.class2}`}
                    type="checkbox"
                    defaultChecked
                  />
                  <label className="">{idx.text}</label>
...
<label className="form-check-label" htmlFor="primaryChecked">
   info
        ...
        <Col>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Colored Radios</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              {Checkdata1.map((idx) => (
                <div className={`form-check ${idx.class1}`} key={Math.random()}>
                  <input
                    id={idx.id}
                    className={`form-check-input form-checked form-checked-${idx.class2}`}
                    type="radio"
                    defaultChecked
                  />
                  <label className="">{idx.text}</label>
...
<label className="form-check-label" htmlFor="primaryChecked">
    info
        ...
        <Col>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Outline Radios</Card.Title>
              <div className="prism-toggle">
                <Button
...
<label className="form-check-label" htmlFor="primaryChecked">
    info
        ...
        <Col>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Switches Colors</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              {Checkdata1.map((idx) => (
                <div
                  className={`form-check form-switch ${idx.class1}`}
                  key={Math.random()}
                >
                  <input
                    id={idx.id}
    ...
    info
      ...
      <Row>
        <Col xl={6} lg={6} md={6} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Toggle Switches Style-1</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <Row className="row gy-1">
                ...
                <Col xl={4}>
                  <div
                    className={`toggle mb-3  toggle-secondary ${secondary1}`}
                    onClick={() => {
                      secondary1 == "on"
                        ? setsecondary1("off")
                        : setsecondary1("on");
                ...
                <Col xl={4}>
                  <div
                    className={`toggle mb-3  toggle-warning ${warning1}`}
                    onClick={() => {
                      warning1 == "on" ? setwarning1("off") : setwarning1("on");
                    }}
                  >
                    <span></span>
                  </div>
                ...
                <Col xl={4}>
                  <div
                    className={`toggle mb-3  toggle-info ${info1}`}
                    onClick={() => {
                      info1 == "on" ? setinfo1("off") : setinfo1("on");
                    }}
                  >
                    <span></span>
                  </div>
                ...
                <Col xl={4}>
                  <div
                    className={`toggle mb-3  toggle-success ${success1}`}
                    onClick={() => {
                ...
                <Col xl={4}>
                  <div
                    className={`toggle mb-3  toggle-danger ${danger1}`}
                    onClick={() => {
                      danger1 == "on" ? setdanger1("off") : setdanger1("on");
                    }}
                  >
                    <span></span>
                  </div>
                ...
                <Col xl={4}>
                  <div
                    className={`toggle mb-3  toggle-light ${light1}`}
                    onClick={() => {
                      light1 == "on" ? setlight1("off") : setlight1("on");
                    }}
                  >
                    <span></span>
                  </div>
                ...
                <Col xl={4}>
                  <div
                    className={`toggle ms-sm-2  toggle-dark ${dark1}`}
                    onClick={() => {
            ...
            <Collapse in={open21} className="card-body">
              <pre>
                <code>{`export default function BasicModal () {   
    const [secondary1, setsecondary1] = useState("on");
    const [success1, setsuccess1] = useState("on");
    const [dark1, setdark1] = useState("on");
    const [primary1, setprimary1] = useState("on");
...
return(
    ...
    <div className={toggle mb-3  toggle-warning 00024{warning1}} onClick={() => { warning1 == "on" ? setwarning1("off") : setwarning1("on"); }} >
        ...
        <Col xl={6} lg={6} md={6} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Toggle Switches Style-2</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <div className="row gy-1">
                ...
                <Col xl={4}>
                  <div className="custom-toggle-switch d-flex align-items-center mb-4">
                    <Form.Control
                      id="toggleswitchSecondary"
                      name="toggleswitch001"
                      type="checkbox"
                      defaultChecked
                    />
                    <Form.Label
                      htmlFor="toggleswitchSecondary"
                      className="label-secondary"
                    ></Form.Label>
                    <span className="ms-3">Secondary</span>
                  </div>
                </Col>
                <Col xl={4}>
                  <div className="custom-toggle-switch d-flex align-items-center mb-4">
                    <Form.Control
                      id="toggleswitchWarning"
                      name="toggleswitch001"
                      type="checkbox"
                      defaultChecked
                    />
                    <Form.Label
                      htmlFor="toggleswitchWarning"
                ...
                <Col xl={4}>
                  <div className="custom-toggle-switch d-flex align-items-center mb-4">
                    <Form.Control
                      id="toggleswitchSuccess"
                      name="toggleswitch001"
                      type="checkbox"
                      defaultChecked
                    />
                    <Form.Label
                      htmlFor="toggleswitchSuccess"
                ...
                <Col xl={4}>
                  <div className="custom-toggle-switch d-flex align-items-center mb-4">
                    <Form.Control
                      id="toggleswitchDanger"
                      name="toggleswitch001"
                      type="checkbox"
                      defaultChecked
                    />
                    <Form.Label
                      htmlFor="toggleswitchDanger"
                      className="label-danger"
                    ></Form.Label>
                    <span className="ms-3">Danger</span>
                  </div>
                </Col>
                <Col xl={4}>
                  <div className="custom-toggle-switch d-flex align-items-center mb-4">
                    <Form.Control
                      id="toggleswitchLight"
                      name="toggleswitch001"
                      type="checkbox"
                      defaultChecked
                    />
                    <Form.Label
                      htmlFor="toggleswitchLight"
    ...
    info
      ...
      <Row>
        <Col xl={6} lg={12} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Toggle Switch-1 Sizes</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <div className="d-flex align-items-center flex-wrap mb-3">
                <div className="">
                  ...
                  <p className="text-muted m-0">
                    Small size toggle switch <code>toggle-sm</code>
                  </p>
                </div>

                <div
                  className={`toggle  toggle-sm mb-0 ${primary2}`}
                  onClick={() => {
              ...
              <div className="d-flex align-items-center flex-wrap mb-3">
                <div className="">
                  {" "}
                  <p className="text-muted m-0">
                    Default toggle switch <code></code>
                  </p>
                </div>

                <div
                  className={`toggle mb-0  toggle-secondary ${secondary2}`}
                  onClick={() => {
                    secondary2 == "on"
                      ? setsecondary2("off")
                      : setsecondary2("on");
              ...
              <div className="d-flex align-items-center flex-wrap">
                <div className="">
                  {" "}
                  <p className="text-muted m-0">
                    Large size toggle switch <code>toggle-lg</code>
                  </p>
                </div>

                <div
                  className={`toggle toggle-lg mb-0  toggle-success ${success2}`}
                  onClick={() => {
                    success2 == "on" ? setsuccess2("off") : setsuccess2("on");
                  }}
                >
                  <span></span>
                </div>
 ...
 <div className="toggle toggle-lg toggle-success on mb-0">
     <span></span>
        ...
        <Col xl={6} lg={12} md={12} sm={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Toggle Switch-2 Sizes</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              ...
              <div className="d-flex align-items-center flex-wrap mb-4">
                <div className="">
                  <p className="text-muted m-0">Default toggle switch</p>
                </div>
                <div className="custom-toggle-switch ms-2">
                  ...
                  <Form.Label
                    ...
                    className="label-secondary mb-1"
                  ></Form.Label>
                </div>
              </div>
