          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              <div className="row gy-3">
                <Col xl={12}>
                  <Form.Label htmlFor="input-noradius">
                ...
                <Col xl={12}>
                  <Form.Label htmlFor="input-rounded-pill">
                    Rounded Input
                  </Form.Label>
                  <Form.Control
                    type="text"
...
<Col xl={12}>
    ...
    <Form.Control type="text" className="form-control rounded-pill" id="input-rounded-pill" placeholder="Rounded"/>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Input border Styles</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <div className="row gy-3">
                ...
                <Col xl={12}>
                  ...
                  <Form.Control
                    type="text"
                    className="form-control border-dotted"
                    id="input-rounded2"
                    placeholder="Dotted"
                  />
                </Col>
     ...
     <Form.Control type="text" className="form-control border-dashed" id="input-rounded3" placeholder="Dashed"/>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Input Sizing</Card.Title>
              <div className="prism-toggle">
                <Button
...
placeholder=".form-control-lg" aria-label=".form-control-lg example"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
        ...
        <Col xl={6}>
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header className="justify-content-between">
                  <Card.Title>Form text</Card.Title>
                  <div className="prism-toggle">
                    <Button
     ...
     must not contain spaces, special characters, or emoji.
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header className="justify-content-between">
                  <Card.Title>
                    Inline text can use any typical inline HTML element with
                    nothing more than the{" "}
                    <span className="text-danger">.form-text</span> class.
                  </Card.Title>
                  <div className="prism-toggle">
                    <Button
 ...
 <div className="col-auto">
     <span id="passwordHelpInline" className="form-text">
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Disabled forms</Card.Title>
              <div className="prism-toggle">
                <Button
