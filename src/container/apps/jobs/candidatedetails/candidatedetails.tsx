                    ...
                    <div className="ms-3">
                      <h4 className="fw-bold mb-0 d-flex align-items-center">
                        <Link to="#">
                          ...
                          Brenda Simpson{" "}
                          <i
                            className="bi bi-check-circle-fill text-success fs-16"
                      ...
                      <div className="popular-tags">
                        <Link
                          to="#"
                          className="badge rounded-pill bg-info-transparent me-1"
                        >
                          <i className="bi bi-moon-stars me-1"></i>Full Time
                        </Link>
                        <Link
                          to="#"
                          className="badge rounded-pill bg-danger-transparent"
                        >
        ...
        <Row>
            ...
            <Card className="custom-card">
              ...
              <Card.Body className="card-body p-0 candidate-edu-timeline">
                <div className="p-4 border-bottom">
                  <h5 className="fw-semibold fs-17 d-flex align-items-center gap-2">
                  ...
                  <div className="ms-4 ps-3">
                    <p className="op-9">
                      ...
                      labore.A officiis optio temporibus minima facilis...
                    </p>
                    <p className="mb-0 op-9">
                      Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd
                      diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero
                      sanctus labore no sed ipsum ipsum nonumy vero sanctus
                      labore..
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 border-bottom">
                  ...
                  <div className="ms-4 ps-3">
                    <p>
                      <span className="fw-semibold">Name : </span> Nicole Chiu
                    </p>
                    <p>
                    ...
                    <p>
                      <span className="fw-semibold">Mobile : </span> +91
                      7865443679
                    </p>
                    <p>
                    ...
                    <p className="mb-0">
                      <span className="fw-semibold">Location : </span> Hyderabad
                    </p>
                  </div>
                </div>
              </Card.Body>
              ...
              <Card.Body className="card-body p-0 candidate-edu-timeline">
                ...
                <div className="p-4 border-bottom">
                  ...
                  <div className="ms-4 ps-3">
                    ...
                    <ol className="list-group border-0 list-bullets">
                      <li className="border-0 py-1">
                        In charge of Organizing activities for approximately
                        100+ internation schools in 2015
                      </li>
                      <li className="border-0 py-1">
                        In charge of Organizing activities for approximately
                        100+ internation schools in 2015
                        ...
                        <Card.Body>
                          <div className="d-flex mb-3 align-items-center flex-wrap gap-2">
                              ...
                              <h5 className="fw-semibold mb-0 d-flex align-items-center">
                                <Link to="#">
                                  ...
                                  <OverlayTrigger
                                    placement="top"
                                    overlay={
                                      <Tooltip>Verified candidate</Tooltip>
                                    }
                                  >
                            ...
                            <div className="btn-list">
                              ...
                              >
                                <Link
                                  to="#"
                                  className="avatar avatar-rounded avatar-sm bg-light text-default"
                                >
                                  <span>
                          ...
                          <div className="popular-tags">
                            ...
                            <Link
                              ...
                              className="badge rounded-pill bg-light text-default me-1"
                            >
                              <i className="bi bi-broadcast text-muted me-1"></i>{" "}
                              Good at English
                            </Link>
                          </div>
                        </Card.Body>
                          ...
                          <div className="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div>
                              <OverlayTrigger
                                placement="top"
                                overlay={
                                  <Tooltip>1 year bond accepted</Tooltip>
                                }
                              >
                                <Link
                                  to="#"
                              ...
                              >
                                <i className="bi bi-briefcase me-1"></i>Exp : 2
                                Years
                              </Link>
                            </div>
                          </div>
                            ...
                            <div>
                              ...
                              >
                                <Link
                                  ...
                                  title="1 year bond accepted"
                                >
                                  <i className="bi bi-hand-thumbs-up me-1"></i>2
                                  years bond accepted
                                </Link>
                              </OverlayTrigger>
                              <Link
                                ...
                                className="badge badge-md rounded-pill bg-primary-transparent"
                              >
                                <i className="bi bi-briefcase me-1"></i>Exp : 4
                                Years
                              </Link>
                            </div>
                          </div>
                          ...
                          <div className="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div>
                              <Link
                                ...
                                className="badge badge-md rounded-pill bg-primary-transparent"
                              >
                                <i className="bi bi-briefcase me-1"></i>Exp : 5
                                Years
                              </Link>
                            </div>
                          </div>
          ...
          <Col lg={4}>
            ...
            <Card className="custom-card">
              ...
              <Card.Body>
                <p>
                  <span className="fw-semibold">English : </span>Fluent
                </p>
                <p>
                  <span className="fw-semibold">Hindi : </span>Intermediate
                </p>
                <p className="mb-0">
                  <span className="fw-semibold">Telugu : </span>Expert
                </p>
              </Card.Body>
            </Card>
            <Card className="custom-card overflow-hidden">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="btn-list mb-0">
                    <Button
                      ...
                      className="btn btn-sm btn-icon btn-wave waves-effect waves-light mb-xl-0"
                    >
            ...
            <Card className="custom-card">
              <Card.Body>
                <div className="">
                  ...
                  <p>
                    Latest candidate updates on the go to recieved direct to
                    your email. Stay updated with your latest new candidates
                    list.
                  </p>
