          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              <div className="row gy-4 mb-4">
                <Col xl={6}>
                  <Form.Label htmlFor="job-title" className="form-label">
                    Job Title
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <Col xl={6}>
                  ...
                  <MultiSelect
                    ...
                    labelledBy="1"
                    className="rounded-0 custom-select1"
                  />
                </Col>
                <Col xl={6}>
                ...
                <Col xl={6}>
                  <Form.Label htmlFor="job-deadline" className="form-label">
                    Job Deadline
                  </Form.Label>
                  <DatePicker
                    selected={startDate}
                ...
                <Col xl={6}>
                  <Form.Label htmlFor="language" className="form-label">
                    Languages :
                  </Form.Label>
                  <Select
                    isMulti
                ...
                <Col xl={6}>
                  <Form.Label htmlFor="qualification" className="form-label">
                    Qualification :
                  </Form.Label>
                  <Select
                    isMulti
                ...
                <Col xl={12}>
                  <Form.Label htmlFor="job-description" className="form-label">
                    Job Description :
                  </Form.Label>
                  <Form.Control
                    as="textarea"
        ...
        <Col xxl={3} xl={4}>
          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              <Row className="gy-3">
                <Col xl={12}>
                  <Form.Label htmlFor="Company-Name" className="form-label">
                    Company Name
                  </Form.Label>
                  <Form.Control
                    type="text"
                    ...
                    defaultValue="Obligation Pvt.Ltd"
                  />
                </Col>
                <Col xl={12}>
                  <Form.Label htmlFor="Company-Website" className="form-label">
                    Company Website
                  </Form.Label>
                  <Form.Control
                    type="text"
                    ...
                    defaultValue="http//www.obligationpvtltd.com"
                  />
                </Col>
                <Col xl={12}>
                  ...
                  <Select
                    ...
                    className="basic-multi-select"
                    classNamePrefix="Select2"
                    defaultValue={[Data11[0]]}
                  />
                </Col>
                <Col xl={12}>
                  <Form.Label htmlFor="Company-Address" className="form-label">
                    Address
                  </Form.Label>
                  <Form.Control
                    type="text"
