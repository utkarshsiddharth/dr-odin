      ...
      <Row>
              ...
              <div className="row gy-3 justify-content-between">
                ...
                <Col xxl={8} xl={12}>
                  <div className="row gy-3">
                    ...
                    <Col xl={12}>
                      <Form.Label htmlFor="nft-link" className="form-label">
                        External Link
                      </Form.Label>
                      <Form.Control
                        type="text"
                ...
                <Col xl={12}>
                  <div className="row gy-3">
                    ...
                    <Col xl={6}>
                      <Form.Label htmlFor="nft-price" className="form-label">
                        NFT Price
                      </Form.Label>
                      <Form.Control
                        type="text"
                    ...
                    <Col xl={4}>
                      <Form.Label htmlFor="nft-size" className="form-label">
                        NFT Size
                      </Form.Label>
                      <Form.Control
                        type="text"
                    ...
                    <Col xl={4}>
                      <Form.Label htmlFor="nft-royality" className="form-label">
                        Royality
                      </Form.Label>
                      <Select
                        options={Data1}
                    ...
                    <Col xl={4}>
                      <Form.Label htmlFor="nft-property" className="form-label">
                        Property
                      </Form.Label>
                      <Form.Control
                        type="text"
                    ...
                    <Col xl={12}>
                      ...
                      >
                        ...
                        />
                        <Form.Label
                          className="btn btn-sm btn-outline-primary text-default z-0"
                          htmlFor="strap1"
                        >
                          <i className="ti ti-tag me-1 align-middle fs-15 d-inline-block"></i>
                          Fixed Price
                        </Form.Label>
                        <input
                          type="radio"
                        ...
                        <Form.Label
                          ...
                          htmlFor="strap2"
                        >
                          <i className="ti ti-users fs-15 me-1 align-middle d-inline-block"></i>
                          Open For Bids
                        </Form.Label>
                        <input
                          type="radio"
                        ...
                        <Form.Label
                          ...
                          htmlFor="strap3"
                        >
                          <i className="ti ti-hourglass-low fs-15 me-1 align-middle d-inline-block"></i>
                          Timed Auction
                        </Form.Label>
                      </div>
                    </Col>
        ...
        <Col xxl={3} xl={4}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>NFT Preview Here</Card.Title>
            </Card.Header>
            <Card.Body>
              <Card className="custom-card mb-0 shadow-none border">
                ...
                <div className="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                  <div className="flex-fill">
                    <Button
                      variant="success"
                      className="btn btn-sm btn-icon rounded-pill btn-wave waves-effect waves-light"
                    >
                ...
                <Card.Body>
                  ...
                  <p className="fs-15 fw-semibold mb-2">
                    <Link to="#">Digital Dreamscape</Link>
                  </p>
                  <div className="d-flex flex-wrap align-itesm-center justify-content-between">
                    <div className="fw-semibold">Highest Bid -</div>
