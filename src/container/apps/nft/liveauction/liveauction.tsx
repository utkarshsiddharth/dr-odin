          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
            <div className="nft-tag nft-tag-primary active">
              ...
              <span className="nft-tag-icon">
                <i className="ti ti-world fs-20"></i>
              </span>
            ...
            <div className="nft-tag nft-tag-secondary">
              <Link to="#" className="stretched-link"></Link>
              <span className="nft-tag-icon">
                <i className="ti ti-flame fs-20"></i>
              </span>
            ...
            <div className="nft-tag nft-tag-info">
              <Link to="#" className="stretched-link"></Link>
              <span className="nft-tag-icon">
                <i className="ti ti-palette fs-20"></i>
              </span>
            ...
            <div className="nft-tag nft-tag-success">
              <Link to="#" className="stretched-link"></Link>
              <span className="nft-tag-icon">
                <i className="ti ti-device-gamepad-2 fs-20"></i>
              </span>
            ...
            <div className="nft-tag nft-tag-warning">
              <Link to="#" className="stretched-link"></Link>
              <span className="nft-tag-icon">
                <i className="ti ti-music fs-20"></i>
              </span>
                  ...
                  <Card.Body className="card-body p-3">
                    <div className="mb-3 overflow-hidden position-relative">
                      ...
                      <span className="nft-timer-container">
                        ...
                        <span className="nft-timer ms-1 fs-11">
                          04 Days 03 : 44 : 04
                        </span>
                      </span>
                    </div>
                    <div className="d-flex justify-content-between align-items-start mb-3 flex-wrap">
                      <div className="d-inline-flex align-items-start position-relative">
                        ...
                        <div className="flex-grow-1">
                          <span className="mb-0 d-block fs-14 fw-semibold">
                            {idx.name}
                          </span>
                          <span className="fs-13 text-muted">
                            {idx.text1}
                            <i className="bi bi-patch-check-fill text-success ms-1 fs-15"></i>
                          </span>
                        </div>
                      </div>
                      <span className="fs-13 text-muted">{idx.text2}</span>
                    </div>
                    <div className="fs-15 fw-semibold mb-2">
                      <Link to="#">{idx.heading}</Link>
                    </div>
                    <div className="d-flex align-items-end flex-wrap gap-2">
                      ...
                      <Link to="#" className="btn btn-primary-light btn-wave">
                        Place Bid
                      </Link>
                    </div>
                  </Card.Body>
            ...
            <Col xl={12}>
              <Card className="custom-card overflow-hidden">
                <div className="card-header justify-content-between">
                  <Card.Title>Featured Creators</Card.Title>
                  <div>
                    <Button
                  ...
                  <ListGroup variant="flush" className=" list-group-flush">
                    ...
                    <ListGroup.Item>
                      <div className="d-flex gap-3 align-items-center flex-wrap">
                        ...
                        <div>
                          <div className="mb-1">
                            <span className="fw-semibold">DreamSpace</span>
                            <span className="fs-12 text-muted ms-2">
                              16 mins ago
                            </span>
                          </div>
                          <div className="fs-13">
                            You started following mark zensberg.
                          </div>
                        </div>
                      </div>
                    </ListGroup.Item>
                    <ListGroup.Item>
                      <div className="d-flex gap-3 align-items-center flex-wrap">
                        ...
                        <div>
                          <div className="mb-1">
                            <span className="fw-semibold">Neo Nebulae</span>
                            <span className="fs-12 text-muted ms-2">
                              5 mins ago
                            </span>
                          </div>
                          <div className="fs-13">
                            You showed interest in purchasing{" "}
                            <Link
                              to="#"
                              className="fs-12 text-warning fw-semibold"
                            >
                              NeoNebulae
                            </Link>
                            .
                      ...
                      <div className="d-flex gap-3 align-items-center flex-wrap">
                        ...
                        <div>
                          ...
                          <div className="fs-13">
                            ...
                            for{" "}
                            <span className="fw-semibold fs-12 text-pink">
                              1.345ETH
                            </span>
                            .
                          </div>
