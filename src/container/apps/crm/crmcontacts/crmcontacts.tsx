        ...
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
              <Card.Title>
                Contacts
                <span className="badge bg-light text-default rounded ms-1 fs-12 align-middle">
                  28
                </span>
              </Card.Title>
              <div className="d-flex flex-wrap gap-2">
                ...
                <Button variant="success-light" className="btn  btn-sm">
                  Export As CSV
                </Button>
                <Dropdown>
                  <Dropdown.Toggle
                    variant="light"
                    className="btn btn-light btn-sm btn-wave waves-effect waves-light no-caret"
                  >
                    Sort By
                      ...
                      <tr className="crm-contact" key={Math.random()}>
                        ...
                        <td>
                          <div className="d-flex align-items-center gap-2">
                            ...
                            <div>
                              ...
                              <span
                                className="d-block text-muted fs-11"
                        ...
                        <td>
                          <div className="d-flex align-items-center flex-wrap gap-1">
                            <span
                              className={`badge bg-${idx.color1}-transparent ${idx.class1}`}
                            >
                              {idx.text3}
                            </span>
                            <span
                              className={`badge bg-${idx.color2}-transparent ${idx.class2}`}
                            >
                              {idx.text4}
                            </span>
                          </div>
                        ...
                        <td>
                          <div className="btn-list">
                            ...
                            <Button
                              variant=""
                              className="btn btn-sm btn-info-light btn-icon"
                            >
                              <i className="ri-pencil-line"></i>
                            </Button>
                            <Button
                              variant=""
                              className="btn btn-sm btn-danger-light btn-icon contact-delete"
        ...
        <Offcanvas.Body className="offcanvas-body p-0">
            ...
            <div className="flex-fill main-profile-info">
              <div className="d-flex align-items-center justify-content-between">
                ...
                <Button
                  variant=""
                  type="button"
                  className="btn-close crm-contact-close-btn"
                  onClick={handleClose}
              ...
              <p className="fs-12 text-fixed-white mb-4 op-5">
                <span className="me-3">
                  <i className="ri-building-line me-1 align-middle"></i>Georgia
                </span>
                <span>
          ...
          <div className="p-4 border-bottom border-block-end-dashed d-flex align-items-center">
            ...
            <div className="btn-list mb-0">
              <Button
                variant=""
                className="btn btn-sm btn-icon btn-primary-light btn-wave waves-effect waves-light mb-0"
              >
                <i className="ri-facebook-line fw-semibold"></i>
              </Button>
              <Button
                variant=""
                className="btn btn-sm btn-icon btn-secondary-light btn-wave waves-effect waves-light mb-0"
              >
                <i className="ri-twitter-line fw-semibold"></i>
              </Button>
              <Button
                variant=""
                className="btn btn-sm btn-icon btn-warning-light btn-wave waves-effect waves-light mb-0"
              >
                <i className="ri-instagram-line fw-semibold"></i>
              </Button>
              <Button
                variant=""
                className="btn btn-sm btn-icon btn-success-light btn-wave waves-effect waves-light mb-0"
              >
                <i className="ri-github-line fw-semibold"></i>
              </Button>
              <Button
                variant=""
                className="btn btn-sm btn-icon btn-danger-light btn-wave waves-effect waves-light mb-0"
              >
          ...
          <div className="p-4">
            <p className="fs-14 mb-2 fw-semibold">
              ...
              <a className="fs-14 text-primary mb-0 float-end" href="#">
                <i className="ri-add-line me-1 align-middle"></i>Add Manager
              </a>
            </p>
          ...
          <div className="modal-content">
            ...
            <Modal.Body className="modal-body px-4">
              <div className="row gy-3">
                ...
                <Col xl={6}>
                  <Form.Label htmlFor="contact-lead-score">
                    Lead Score
                  </Form.Label>
                  <Form.Control
                    type="number"
