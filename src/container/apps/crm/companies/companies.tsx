...
const Companies: FC<CompaniesProps> = () => {
  const [selectedImage, setSelectedImage] = useState<string | null>(logo11); // Set the default image URL here
          ...
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              ...
              <div className="d-flex flex-wrap gap-2">
                ...
                <Button
                  variant=""
                  className="btn btn-success-light btn-sm btn-wave"
                >
                  Export As CSV
                </Button>
                <Dropdown>
                  <Dropdown.Toggle
                    variant=""
                    href="#"
                    className="btn btn-light btn-sm btn-wave no-caret"
                  >
                    Sort By
                      ...
                      <tr className="crm-contact" key={Math.random()}>
                        ...
                        <td>
                          <div className="d-flex align-items-center flex-wrap gap-1">
                            <span
                              className={`badge bg-${idx.color} ${idx.class}`}
                            >
                              {idx.badge}
                            </span>
                          </div>
      ...
      >
        <div className="offcanvas-body p-0">
          ...
          <div className="p-4 border-bottom border-block-end-dashed">
            <div className="mb-0">
              ...
              <p className="text-muted op-8 mb-0">
                <b className="text-default">Spruko</b> Technologies is a leading
          ...
          <div className="p-4 border-bottom border-block-end-dashed">
            ...
            <div className="">
              <div className="d-flex align-items-center mb-2">
                ...
                <div>sprukotechnologies2981@gmail.com</div>
              </div>
              <div className="d-flex align-items-center mb-2">
                <div className="me-2">
                  <span className="avatar avatar-sm avatar-rounded bg-light text-muted">
          ...
          <div className="p-4 border-bottom border-block-end-dashed d-flex align-items-center gap-3">
            ...
            <div>
              <span className="badge bg-primary-transparent m-1">
                Corporate
              </span>{" "}
              - 1001+ Employees
            </div>
          ...
          <div className="p-4 d-flex align-items-center gap-3">
            <div className="fs-14 fw-semibold">Key Contact :</div>
            <div className="d-flex align-items-center gap-2">
              <div className="lh-1">
                <span className="avatar avatar-rounded avatar-sm">
