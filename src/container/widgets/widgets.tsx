    ...
    <Fragment>
              ...
              <div className="d-flex align-items-top">
                ...
                <div className="flex-fill">
                  ...
                  <div className="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div className="flex-fill">
                      <span className="ms-2 badge bg-success-transparent rounded-pill">
                        +25.8%
                      </span>
                    </div>
                    <div id="btcCoin">
                    ...
                    <div className="flex-fill">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <span className="fs-12 text-success ms-2">
                          <i className="ti ti-trending-up me-1 d-inline-block"></i>
                          0.5%
                        </span>
                      </div>
                    </div>
            ...
            <Col xl={6}>
              <Card className="custom-card">
                <Card.Body>
                  ...
                  <span className="fs-5 fw-semibold">9,231</span>
                  <span className="fs-12 text-success ms-1">
                    <i className="ti ti-trending-up me-1 d-inline-block"></i>
                    0.5%
                  </span>
                </Card.Body>
            ...
            <Col xl={6}>
              <Card className="custom-card">
                <Card.Body>
                  ...
                  <ProgressBar
                    variant="success"
                    className="progress progress-xs mb-4"
                    now={25}
                  />
                ...
                <div className="card-footer text-center">
                  <div className="d-grid">
                    <Link to="#" className="text-primary">
                      View Details <i className="ti ti-external-link"></i>
                    </Link>
                  </div>
                </div>
              </Card>
                ...
                <Card.Body>
                  <div className="d-flex align-items-center mb-3">
                    <div className="flex-fill d-flex align-items-center">
                      <div className="me-2">
                        <span className="avatar rounded-2 text-bg-primary fs-20">
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    <div className="avatar-list-stacked">
                      <Link
                        ...
                        data-bs-toggle="tooltip"
                        aria-label="Mis x matched"
                      >
                        <img src={face2} alt="img" className="w-100" />
                      </Link>
                      <Link
                        to="#"
                        className="avatar avatar-sm rounded-circle overflow-hidden"
                        data-bs-toggle="tooltip"
                        aria-label="Barbel Bob"
                      >
                        <img src={face12} alt="img" className="w-100" />
                      </Link>
                      <Link
                        to="#"
                        className="avatar avatar-sm rounded-circle overflow-hidden"
                        ...
                        aria-label="Phan Rel"
                      >
                        <img src={face20} alt="img" className="w-100" />
                      </Link>
                      <Link
                        to="#"
                        className="avatar avatar-sm rounded-circle overflow-hidden bg-primary text-fixed-white"
                        data-bs-toggle="tooltip"
                      >
                        +4
                      </Link>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Body>
                  <div className="d-flex align-items-center">
                    <div className="flex-fill">
                      <p className="mb-1 fs-5 fw-semibold text-default">
                        1,773
                      </p>
                    ...
                    <div className="ms-2">
                      <span className="avatar text-bg-info rounded-circle fs-20">
              ...
              <Card className="custom-card">
                <Card.Body>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2">
                      <span className="avatar text-bg-success rounded-circle fs-20">
              ...
              <Card className="custom-card card-bg-primary">
                <Card.Header className="card-header justify-content-between border-bottom-0">
                  ...
                  <div>
                    <Button
                      variant=""
                      className="btn btn-sm btn-icon text-bg-primary transform-arrow"
                    >
                  ...
                  <div className="d-flex flex-wrap align-items-top">
                    <div className="flex-fill overflow-hidden">
                      ...
                      <p className="mb-0 fs-12 text-fixed-white op-7">
                        <span>
                          <i className="bi bi-caret-up-fill"></i> 2.3%
                        </span>
                  ...
                  <div className="p-3">
                    <div className="d-flex flex-wrap mb-1">
                      <Link to="#" className="pe-2">
                        <span className="avatar border text-muted text-primary">
                          <i className="ri-apple-fill fs-18"></i>
                        </span>
                      </Link>
                      <div className="flex-fill">
                        <div className="d-flex flex-wrap align-items-center justify-content-between mb-1">
                          ...
                          <span className="text-success text-end">
                            <i className="ti ti-trending-up fs-11 me-1 d-inline-block"></i>
                            0.14%
                          </span>
                        </div>
                    ...
                    <div className="d-flex align-items-center">
                      <Link
                        to="#"
                        className="flex-fill btn btn-sm btn-light me-2"
                      >
                        Short
                      </Link>
                      <Link
                        to="#"
                        className="flex-fill btn btn-sm btn-primary-light"
                      >
                        Buy
                      </Link>
                    </div>
                ...
                <Card.Body className="card-body p-0">
                  <div className="p-3">
                    <div className="d-flex flex-wrap mb-1">
                      <Link to="#" className="pe-2">
                        <span className="avatar border text-muted text-primary">
                          <i className="ri-bit-coin-fill fs-18"></i>
                        </span>
                      </Link>
                      <div className="flex-fill">
                        <div className="d-flex flex-wrap align-items-center justify-content-between mb-1">
              ...
              <div className="d-flex align-items-top justify-content-between mb-4">
                <div className="flex-fill d-flex align-items-top">
                  ...
                  <div className="flex-fill">
                    ...
                    <p className="mb-0 text-muted fs-12 op-7">
                      Magna sit elitr kasd consetetur.
                    </p>
                  </div>
                </div>
                <div>
                ...
                <div className="flex-fill d-flex align-items-top">
                  <div className="me-2">
                    <span className="avatar avatar-md text-secondary border bg-light">
                      <i className="ti ti-user-circle fs-18"></i>
                    </span>
                  </div>
                  <div className="flex-fill">
                    <p className="fw-semibold fs-14 mb-0">Recruiters</p>
                    <p className="mb-0 text-muted fs-12 op-7">
                      Elitr at gubergren sit sed.
                    </p>
                  </div>
                </div>
                <div>
                ...
                <div className="flex-fill d-flex align-items-top">
                  <div className="me-2">
                    <span className="avatar avatar-md text-success border bg-light">
                      <i className="ti ti-view-360 fs-18"></i>
                    </span>
                  </div>
                  <div className="flex-fill">
                    <p className="fw-semibold fs-14 mb-0">Page Views</p>
                    <p className="mb-0 text-muted fs-12 op-7">
                      Sed duo ut sanctus gubergren.
                    </p>
                  </div>
                </div>
                <div>
      ...
      <Row>
        {Salesdata.map((idx) => (
          <Col xl={2} key={Math.random()}>
            <Card
              className={`custom-card border-top-card border-top-${idx.color} rounded-0`}
            >
              <Card.Body>
                <div className="text-center">
                  <span
                    className={`avatar avatar-md bg-${idx.color} shadow-sm avatar-rounded mb-2`}
                  >
                  ...
                  <div className="d-flex align-items-center justify-content-center flex-wrap">
                    ...
                    <Badge bg={idx.bg} className="badge  rounded-pill ms-1">
                      {idx.badge}
                    </Badge>
                  </div>
                </div>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <div className="card-header justify-content-between">
              ...
              <div>
                <Button variant="" className="btn btn-sm btn-primary-light">
                  View All
                </Button>
              </div>
            </div>
            <Card.Body>
              <Tab.Container defaultActiveKey="1">
                <Nav
                  className="nav-style-1 nav-pills mb-4 nav-justified"
                  role="tablist"
                >
                  <Nav.Link
                    eventKey="1"
                  ...
                  <div className="d-flex align-items-top">
                    ...
                    <div className="d-flex flex-wrap flex-fill align-items-center justify-content-between">
                      ...
                      <Dropdown>
                        <Dropdown.Toggle
                          variant=""
                          className="p-2 fs-16 text-muted no-caret"
                          data-bs-toggle="dropdown"
                        >
                  ...
                  <tbody>
                    {Trafficsources.map((idx) => (
                      <tr key={Math.random()}>
                        ...
                        <td>
                          <span>
                            <i className="ri-arrow-up-s-fill me-1 text-success align-middle fs-18"></i>
                            {idx.text2}
                          </span>
                        </td>
                        <td>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Users By Country</Card.Title>
            </Card.Header>
            <Card.Body>
              <div className="d-flex flex-wrap justify-content-between mb-5">
                <div className="me-5 d-flex align-items-center">
                  <div className="me-2">
                    <span className="avatar avatar-rounded bg-primary-transparent text-primary">
                      <i className="ri-user-3-line fs-16"></i>
                    </span>
                  </div>
                  <div className="flex-fill">
                    <p className="fs-18 mb-0 text-primary fw-semibold">
                      25,350
                    </p>
                ...
                <div className="me-3 d-flex align-items-center">
                  <div className="me-2">
                    <span className="avatar avatar-rounded bg-light text-default">
                      <i className="ri-user-3-line fs-16"></i>
                    </span>
                  </div>
                  <div className="flex-fill">
                ...
                <div className="me-3 d-flex align-items-center">
                  <div className="me-2">
                    <span className="avatar avatar-rounded bg-success-transparent">
                      <i className="ri-user-3-line fs-16"></i>
                    </span>
                  </div>
                  <div className="flex-fill">
                    <p className="fs-18 mb-0 text-success fw-semibold">
                      1,24,890
                    </p>
                ...
                <div className="me-3 d-flex align-items-center">
                  ...
                  <div className="flex-fill">
                    <p className="fs-18 mb-0 text-secondary fw-semibold">
                      97,799
                    </p>
                  ...
                  <div className="h-100 my-auto">
                    <ListGroup>
                      <ListGroup.Item>
                        <div className="d-flex flex-wrap align-items-center justify-content-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-primary fs-8 me-1 align-middle d-inline-block"></i>
                            Brazil
                          </div>
                          <div>1,290</div>
                      ...
                      <ListGroup.Item>
                        <div className="d-flex flex-wrap align-items-center justify-content-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-secondary fs-8 me-1 align-middle d-inline-block"></i>
                            Greenland
                          </div>
                          <div>2,596</div>
                          <div className="text-danger">
                            <i className="ri-arrow-down-s-line align-middle me-1 d-inline-block"></i>
                            1.1%
                          </div>
                        </div>
                      </ListGroup.Item>
                      <ListGroup.Item>
                        <div className="d-flex flex-wrap align-items-center justify-content-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-success fs-8 me-1 align-middle d-inline-block"></i>
                            Russia
                          </div>
                          <div>3,710</div>
                          <div className="text-success">
                      ...
                      <ListGroup.Item>
                        <div className="d-flex flex-wrap align-items-center justify-content-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-warning fs-8 me-1 align-middle d-inline-block"></i>
                            Palestine
                          </div>
                          <div>1,116</div>
                          <div className="text-danger">
                      ...
                      <ListGroup.Item>
                        <div className="d-flex flex-wrap align-items-center justify-content-between">
                          <div>
                            <i className="ri-checkbox-blank-circle-fill text-danger fs-8 me-1 align-middle d-inline-block"></i>
                            Canada
                          </div>
                          <div>12,150</div>
                          <div className="text-success">
          ...
          <Card className="custom-card">
            ...
            <Card.Body className="card-body pb-3">
              <div className="mb-4">
                ...
                <span className="text-danger me-1 fs-14">
                  {" "}
                  - 1.3%
