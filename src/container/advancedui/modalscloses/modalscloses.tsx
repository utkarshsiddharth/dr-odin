...
<Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}>
    ...
    <Button variant="primary">Understood</Button>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Scrolling long content</Card.Title>
              <div className="prism-toggle">
                <Button
              ...
              <Modal show={show2} onHide={handleClose2} keyboard={false}>
                ...
                <Modal.Body>
                  <p>
                    ...
                    Libero ipsum quasi, error quibusdam debitis maiores hic eum?
                    Vitae nisi ipsa maiores fugiat deleniti quis reiciendis
                    veritatis.
                  </p>
                  <p>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea
                    voluptatibus, ipsam quo est rerum modi quos expedita facere,
                    ex tempore fuga similique ipsa blanditiis et accusamus
                    temporibus commodi voluptas! Nobis veniam illo architecto
                    expedita quam ratione quaerat omnis. In, recusandae eos!
                    Pariatur, deleniti quis ad nemo ipsam officia temporibus,
                    doloribus fuga asperiores ratione distinctio velit alias hic
                    modi praesentium aperiam officiis eaque, accusamus aut.
                    Accusantium assumenda, commodi nulla provident asperiores
                    fugit inventore iste amet aut placeat consequatur
                    reprehenderit. Ratione tenetur eligendi, quis aperiam
                    dolores magni iusto distinctio voluptatibus minus a unde at!
                    Consequatur voluptatum in eaque obcaecati, impedit
                    accusantium ea soluta, excepturi, quasi quia commodi
                    blanditiis? Qui blanditiis iusto corrupti necessitatibus
                    dolorem fugiat consequuntur quod quo veniam? Labore
                    dignissimos reiciendis accusamus recusandae est consequuntur
                    iure.
                  </p>
                  <br />
                  <br />
...
<Button variant="primary">Understood</Button>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Vertical Centered Scrollable</Card.Title>
              <div className="prism-toggle">
                <Button
...
<Button variant="primary">Understood</Button>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Tooltips and popovers</Card.Title>
              <div className="prism-toggle">
                <Button
              ...
              >
                ...
                <Modal.Body>
                  ...
                  <p>
                    ...
                    >
                      <Button variant="secondary" className="me-2 ms-2">
                        button
                      </Button>
                    </OverlayTrigger>
    ...
    Save Changes
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Using the grid</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              ...
              >
                ...
                <Modal.Body>
                  <Container fluid>
                    <Row>
                      <Col md={4} className=" bg-light border">
                        .col-md-4
                      </Col>
                      <Col md={4} className=" ms-auto bg-light border">
                        .col-md-4 .ms-auto
                      </Col>
                    </Row>
                    <Row className="row mt-3">
                      <Col md={3} className=" ms-auto bg-light border">
                        .col-md-3 .ms-auto
                      </Col>
                      <Col md={2} className=" ms-auto bg-light border">
                        .col-md-2 .ms-auto
                      </Col>
                    </Row>
                    <Row className="row mt-3">
                      <Col md={6} className=" ms-auto bg-light border">
                        .col-md-6 .ms-auto
                      </Col>
                    </Row>
                    <Row className="row mt-3">
              ...
              >
                <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h6 className="modal-title" id="staticBackdropLabel5">
                        Modal title
                      </h6>
                      <button
                        type="button"
     ...
     Save Changes
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <Button variant="primary" className="btn" onClick={handleShowt1}>
                Open first modal
              </Button>
              <Modal
                id="m1"
                ...
                centered
                show={showt1}
                onHide={handleCloset1}
              >
                <Modal.Header closeButton>
                  <Modal.Title id="exampleModalToggleLabel">
                    Modal 1
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
              ...
              >
                <div className="modal-dialog modal-dialog-centered">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h6 className="modal-title" id="exampleModalToggleLabel">
                        Modal 1
                      </h6>
                      <button
                        type="button"
              ...
              >
                <div className="modal-dialog modal-dialog-centered">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h6 className="modal-title" id="exampleModalToggleLabel2">
                        Modal 2
                      </h6>
                      <button
                        type="button"
            ...
            <Card.Body>
              ...
              >
                <div className="modal-dialog modal-lg">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h6 className="modal-title" id="exampleModalLgLabel">
                        Large modal
                      </h6>
                      <button
                        type="button"
              ...
              >
                <div className="modal-dialog modal-sm">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h6 className="modal-title" id="exampleModalSmLabel">
                        Small modal
                      </h6>
                      <button
                        type="button"
    ...
    <Modal show={showf} fullscreen={fullscreen} onHide={() => setShowf(false)}>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Varying modal content</Card.Title>
              <div className="prism-toggle">
                <Button
...
`}
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Basic Close</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open13} className="card-body">
              <pre>
                <code>{`<Button variant='' type="button" 
className="btn-close" aria-label="Close"></Button>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Disabel state</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open14} className="card-body">
              <pre>
                <code>{`<Button variant='' type="button"
 className="btn-close" disabled aria-label="Close"></Button>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
