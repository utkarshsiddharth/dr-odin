...
export function Chartjsmixed() {
  return <Scatter options={Option5} data={Data5} height="300px" />;
}
//Polar
const Option6 = {
  responsive: true,
...
export function Chartjspolar() {
  return <PolarArea options={Option6} data={Data6} height="300px" />;
}
//Radar
const Option7 = {
  responsive: true,
...
export function Chartjsradial() {
  return <Radar options={Option7} data={Data7} height="300px" />;
}
...
export function Chartjsscatter() {
  return <Scatter options={Option8} data={Data8} height="300px" />;
}
//Bubble
const Option9: any = {
  responsive: true,
...
export function Chartjsbubble() {
  return <Bubble options={Option9} data={Data9} height="300px" />;
}
