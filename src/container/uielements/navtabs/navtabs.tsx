    ...
    <Fragment>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Static Tabs</Card.Title>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Static Pills</Card.Title>
            </Card.Header>
            <Card.Body>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Default Nav Tabs</Card.Title>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Justified Nav Tabs</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="third">
                ...
                >
                  ...
                  <Nav.Item>
                    <Nav.Link eventKey="third" href="#service1-justified">
                      Services
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link href="#license1-justified" eventKey="fourth">
                      License
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Basic Pill Tabs With Links</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="second">
                ...
                <Tab.Content id="myTabContent">
                  ...
                  <Tab.Pane role="tabpanel" eventKey="second">
                    ...
                    and get away with it. 17 problems with summer activities.
                    How to cheat at travel agents and get away with it. How not
                    knowing family trip ideas makes you a rookie. What everyone
                    is saying about daily deals. How twitter can teach you about
                  ...
                  <Tab.Pane role="tabpanel" eventKey="third">
                    ...
                    success stories. How whole foods markets are making the
                    world a better place. 16 things that won't happen in dish
                    reviews.
                  </Tab.Pane>
                  <Tab.Pane role="tabpanel" eventKey="fourth">
                    ...
                    uniforms. How not knowing food processors makes you a
                    rookie. Why whole foods markets beat peanut butter on
                    pancakes. reviews.
                  </Tab.Pane>
                </Tab.Content>
              </Tab.Container>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Justified Pill Tabs With Links</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="second">
                <Nav
                  ...
                  defaultActiveKey="first"
                >
                  <Nav.Link eventKey="first" href="#nav-products-justified">
                    Products
                  </Nav.Link>

                  <Nav.Link eventKey="second" href="#nav-cart-justified">
                    Cart{" "}
                  ...
                  <Nav.Link eventKey="fourth" href="#nav-offers-justified">
                    Offers{" "}
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Vertical alignment with lists</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Row>
                  <Col xl={3}>
                    ...
                    >
                      <Nav.Item>
                        <Nav.Link href="#home-vertical" eventKey="first">
                          Home
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey="second" href="#about-vertical">
                          About
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link href="#services-vertical" eventKey="third">
                          Services
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link href="#contacts-vertical" eventKey="fourth">
                          Contacts
                        </Nav.Link>
                      </Nav.Item>
                    </Nav>
                  ...
                  <Col xl={9}>
                    <Tab.Content>
                      ...
                      >
                        ...
                        it. 17 problems with summer activities. How to cheat at
                        travel agents and get away with it. How not knowing
                        family trip ideas makes you a rookie. What everyone is
                      ...
                      >
                        ...
                        about safe food handling tips that will impress your
                        friends. Restaurant weeks by the numbers. Will mexican
                        food ever rule the world? The 10 best thai restaurant
                        youtube videos. How restaurant weeks can make you sick.
                        The complete beginner's guide to cooking healthy food.
                      ...
                      >
                        ...
                        would end if restaurants disappeared. Why restaurants
                        are on crack about restaurants. How restaurants are
                        making the world a better place. 8 great articles about
                        minute meals. Why our world would end if healthy snacks
                        disappeared. Why the world would end without mexican
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Vertical alignment with links</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="third">
                <Row>
                    ...
                    >
                      <Nav.Item>
                        <Nav.Link href="#home-vertical-link" eventKey="first">
                          <i className="ri-home-smile-line me-2 align-middle d-inline-block"></i>
                          Home
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey="second" href="#about-vertical-link">
                          <i className="ri-archive-drawer-line me-2 align-middle d-inline-block"></i>
                          About
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        ...
                        >
                          <i className="ri-bank-line me-2 align-middle d-inline-block"></i>
                          Services
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        ...
                        >
                          <i className="ri-contacts-book-2-line me-2 align-middle d-inline-block"></i>
                          Contacts
                        </Nav.Link>
                      </Nav.Item>
                    </Nav>
                  ...
                  <Col xl={9}>
                    <Tab.Content className="tab-content">
                      ...
                      >
                        Unbelievable healthy snack success stories. 12 facts
                        about safe food handling tips that will impress your
                        friends. Restaurant weeks by the numbers.{" "}
                        <b>
                          <i>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Center Aligned Nav</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav
                ...
                >
                  <Nav.Item>
                    <Nav.Link eventKey="first" href="#home-center">
                      Home
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="second" href="#about-center">
                      About
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="third" href="#services-center">
                      Services
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="fourth" href="#contacts-center">
                      Contacts
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Right Aligned Nav</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav
                ...
                >
                  <Nav.Item>
                    <Nav.Link eventKey="first" href="#home-right">
                      Home
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="second" href="#about-right">
                      About
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="third" href="#services-right">
                      Services
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="fourth" href="#contacts-right">
                      Contacts
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
      ...
      <Row>
            ...
            <Tab.Container defaultActiveKey="first">
              <Card.Header className=" justify-content-between">
                ...
                <div>
                  ...
                  >
                    <Nav.Item>
                      <Nav.Link eventKey="first" href="#home-header">
                        Home
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="second" href="#about-header">
                        About
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="third" href="#services-header">
                        Services
                      </Nav.Link>
                    </Nav.Item>
                  </Nav>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Tab.Container defaultActiveKey="first">
              <Card.Header>
                <Card.Title>Footer Tabs</Card.Title>
              </Card.Header>
              <Card.Body>
                <Tab.Content className="tab-content">
                  <Tab.Pane
              ...
              <Card.Footer>
                ...
                >
                  <Nav.Item className="m-1">
                    <Nav.Link eventKey="first" href="#home-footer">
                      Home
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item className="m-1">
                    <Nav.Link eventKey="second" href="#about-footer">
                      About
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item className="m-1">
                    <Nav.Link eventKey="third" href="#services-footer">
                      Services
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
      ...
      <Row>
        <Col xxl={4} xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Tab Style-1</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container defaultActiveKey="first">
                <Nav
                ...
                >
                  <Nav.Item>
                    <Nav.Link eventKey="first" href="#orders">
                      Orders
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="second" href="#accepted">
                      Accepted
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="third" href="#declined">
                      Declined
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
        ...
        <Col xxl={5} xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Tab Style-2</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container defaultActiveKey="second">
                ...
                >
                  <Nav.Item>
                    <Nav.Link eventKey="first" id="order-tab" type="button">
                      <i className="ri-gift-line me-1 align-middle"></i>Ordered
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link
                  ...
                  <Nav.Item>
                    <Nav.Link eventKey="third" id="shipped-tab" type="button">
        ...
        <Col xxl={3} xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Tab-Style-3</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container defaultActiveKey="first">
                <Nav
                ...
                <Tab.Content id="myTabContent1">
                  <Tab.Pane
                    className=" fade show  text-muted"
                    id="home-tab-pane"
                    eventKey="first"
                    tabIndex={0}
                  >
                  ...
                  <Tab.Pane
                    ...
                    tabIndex={0}
                  >
                    Many desktop publishing packages as their default model
                    text, and a search for <b>'lorem ipsum'</b> will over the
                    years.
                  </Tab.Pane>
                  <Tab.Pane
                    className="fade text-muted"
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Tab Style-4</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container defaultActiveKey="first">
                <nav>
                  <Nav
                    ...
                    defaultActiveKey="first"
                  >
                    <Nav.Link eventKey="first" id="nav-home-tab" type="button">
                      Home
                    </Nav.Link>
                ...
                <Tab.Content className="tab-content" id="tab-style-4">
                  ...
                  >
                    ...
                    readable English. <b>Many desktop publishing</b> packages
                    ...
                    purpos, remaining essentially unchanged.
                  </Tab.Pane>
                  <Tab.Pane
                    className="tab-pane"
                    id="nav-contact1"
                  ...
                  >
                    ...
                    look even slightly believable. <b>If you are going</b> to
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Tab Style-5</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container defaultActiveKey="first">
                <Nav
                ...
                <Tab.Content id="pills-tabContent">
                  ...
                  <Tab.Pane
                    ...
                    tabIndex={0}
                  >
                    <b>Contrary to popular belief</b>, Contrary to popular
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Tab Style-6</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container defaultActiveKey="first">
                <Nav
                ...
                >
                  <Nav.Item as="li">
                    <Nav.Link eventKey="first" id="products-tab" type="button">
                      <i className="ri-gift-line me-1 align-middle d-inline-block"></i>
                      Products
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li">
                    <Nav.Link eventKey="second" id="sales-tab" type="button">
                      <i className="ri-bill-line me-1 align-middle d-inline-block"></i>
                      Sales
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li">
                    <Nav.Link eventKey="third" id="profit-tab" type="button">
                      <i className="ri-money-dollar-box-line me-1 align-middle d-inline-block"></i>
                      Profit
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li">
                    <Nav.Link eventKey="fourth" id="expenses-tab" type="button">
        ...
        <Col xl={8}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Vertical Tab Style-1</Card.Title>
            </Card.Header>
                  ...
                  <Col md={2}>
                    ...
                    >
                      <Nav.Link
                        ...
                        type="button"
                      >
                        <i className="ri-shield-user-line me-1 align-middle d-inline-block"></i>
                        Profile
                      </Nav.Link>
                      <Nav.Link
                        eventKey="second"
                        ...
                        type="button"
                      >
                        <i className="ri-u-disk-line me-1 align-middle d-inline-block"></i>
                        Password
                      </Nav.Link>
                      ...
                      <Nav.Link
                        ...
                        type="button"
                      >
                        <i className="ri-group-line me-1 align-middle d-inline-block"></i>
                        Team
                      </Nav.Link>
                      ...
                      <Nav.Link
                        ...
                        type="button"
                      >
                        <i className="ri-mail-line me-1 align-middle d-inline-block"></i>
                        Email
                      </Nav.Link>
                    </Nav>
                  </Col>
                        ...
                        <div className="d-sm-flex">
                          ...
                          <div>
                            <div className="my-md-auto mt-4 ms-md-3">
                              <h5 className="font-weight-semibold ms-2 mb-1 pb-0">
                                Adam Smith
                              </h5>
                              <p className="text-muted ms-0 mb-2 pb-2 ">
                                ...
                                <span className="me-3">
                                  <i className="fa fa-taxi me-2"></i>West
                                  fransisco,Alabama
                                </span>{" "}
                                <span>
                      ...
                      >
                        <ul className="list-unstyled text-muted mb-0">
                          <li className="mb-2">
                            ...
                            industry's{" "}
                            <b>standard dummy text ever since the 1500s</b>,
      ...
      <Row>
        <Col xxl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Vertical Tab Style-2</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Row>
                      ...
                      >
                        <ul className="mb-0">
                          <li className="mb-2">
                            ...
                            think. How cultural solutions can help you predict
                            the future. How to cheat at dog friendly hotels and
                            get away with it. 17 problems with summer
                            activities. How to cheat at travel agents and get
                            away with it. How not knowing family trip ideas
                            makes you a rookie. What everyone is saying about
                            daily deals.
                          </li>
                          <li>
                            There are many variations of passages of Lorem Ipsum
                      ...
                      >
                        <ul className="mb-0">
                          <li className="mb-2">
                            ...
                            versions from the 1914 translation by H. Rackham,How
                            hotel deals can help you live a better life.{" "}
                            <b>How celebrity cruises</b>
                          </li>
                          <li>
                            Contrary to popular belief, Lorem Ipsum is not
        ...
        <Col xxl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Vertical Tabs Style-3</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Row>
                    ...
                    >
                      <Nav.Item>
                        <Nav.Link href="#employee-vertical" eventKey="first">
                          <i className="ri-map-pin-user-line me-2 align-middle d-inline-block"></i>
                          Employees
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey="second" href="#customers-vertical">
                          <i className="ri-group-line me-2 align-middle d-inline-block"></i>
                          Customers
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link
                          ...
                          className="mb-0"
                        >
                          <i className="ri-gift-line me-2 align-middle d-inline-block"></i>
                          Products
                        </Nav.Link>
                      </Nav.Item>
                    </Nav>
                      ...
                      >
                        <ul className="mb-0">
                          ...
                          <li>
                            ...
                            the future. How to cheat at dog friendly hotels and
                            get away with it. 17 problems with summer
                            activities. How to cheat at travel agents.
                          </li>
                        </ul>
                      </Tab.Pane>
                    </Tab.Content>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Tabs with dropdowns</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Pills with dropdowns</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav
                ...
                >
                  <Nav.Item>
                    <Nav.Link eventKey="first" href="#pill-products">
                      Products
                    </Nav.Link>
                  </Nav.Item>
                  <Dropdown className="nav-item dropdown">
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item href="#">Liked</Dropdown.Item>
                      <Dropdown.Item href="#">Save For Later</Dropdown.Item>
                      <li>
                        <hr className="dropdown-divider" />
                      </li>
                  ...
                  <Nav.Item>
                    <Nav.Link eventKey="third" href="#pill-orders">
                      Orders
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                ...
                <Tab.Content>
                  ...
                  >
                    ...
                    you predict the future. How to cheat at dog friendly hotels
                    and get away with it. 17 problems with summer activities.
                    How to cheat at travel agents and get away with it.
                  </Tab.Pane>
                  <Tab.Pane
                    className="text-muted"
                    id="pill-orders"
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>FIll Pills</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav
                ...
                >
                  <Nav.Item>
                    <Nav.Link eventKey="first" href="#fill-pill-home">
                      Home
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="second" href="#fill-pill-about">
                      Customer-ratings
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="third" href="#fill-pill-services">
                      Services
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>justified Pills</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav
                ...
                >
                  <Nav.Item>
                    <Nav.Link eventKey="first" href="#justified-pill-home">
                      Home
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="second" href="#justified-pill-details">
                      Company Details
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="third" href="#justified-pill-products">
                      Products
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Working with flex utilities</Card.Title>
            </Card.Header>
            <Card.Body>
              <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                <Nav
                ...
                >
                  ...
                  <Nav.Link disabled className="flex-sm-fill text-sm-center">
                    Services
                  </Nav.Link>
                </Nav>
                <Tab.Content className="tab-content">
