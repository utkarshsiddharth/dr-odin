...
<div className="btn-group my-1" key={Math.random()}>
    ...
    <Dropdown.Menu as="ul">
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Dropdown Sizing</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<Dropdown.Menu as="ul">
    ...
    <Dropdown.Item as="li" href="#">Separated link</Dropdown.Item>
        ...
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Dropup right</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<Dropdown.Menu as="ul">
    ...
    <Dropdown.Item as="li" href="#">Separated link</Dropdown.Item>
        ...
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Dropup left</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
            ...
            <Card.Body>
              ...
              <div className="btn-group">
                <Dropdown
                  className="btn-group dropstart my-1"
                  role="group"
                  drop="start"
                >
                  <Dropdown.Toggle
 ...
 <Dropdown.Menu as="ul">
     ...
     <Dropdown.Item as="li" href="#">Another link</Dropdown.Item>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Auto close behavior</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
 ...
 <Dropdown>
     ...
     <Dropdown.Menu as="ul" aria-labelledby="defaultDropdown">
        ...
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>dropdowns with Forms</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
    ...
    <Dropdown.Item as="li" href="#">Forgot password?</Dropdown.Item>
      ...
      <Row>
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Dropdown menu centered</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<Dropdown.Menu as="ul" aria-labelledby="dropdownCenterBtn">
    ...
    <Dropdown.Item as="li" href="#">Action three</Dropdown.Item>
        ...
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Dropup centered</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
    ...
    <Dropdown.Item as="li" href="#">Action three</Dropdown.Item>
        ...
        <Col xl={3}>
          <Card className="custom-card">
            ...
            <Card.Body>
              <p className="card-title mb-3">
                You can use <code>&lt;a&gt;</code> or{" "}
                <code>&lt;button&gt;</code> as dropdown items.
              </p>
              <Dropdown className="dropdown">
                <Dropdown.Toggle
                  variant=""
...
<Dropdown.Menu as="ul" aria-labelledby="dropdownMenu1">
    ...
    <Dropdown.Item><Button variant='' as="li" type="button">Something else
        ...
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Dropdowns options</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
    ...
    <Dropdown.Item as="li" href="#">Separated link</Dropdown.Item>
      ...
      <Row>
        <Col xl={9}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Alignment options</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<Dropdown.Menu className="dropdown-menu dropdown-menu-end">
    ...
    <Dropdown.Item><button className="dropdown-item" type="button">Something else
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Responsive alignment end</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<DropdownButton as={ButtonGroup} align={{ lg: 'end' }} title="Left-aligned but right aligned when large screen" id="dropdown-menu-align-responsive-1">
    ...
    <Dropdown.Item eventKey="2">Action 2</Dropdown.Item>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Responsive alignment left</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<Dropdown.Item eventKey="2">Action 2</Dropdown.Item>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Custom Dropdown Menu's</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
                ...
                {CustomButtons.map((idx) => (
                  <div className="btn-group" key={Math.random()}>
                    <Dropdown>
                      ...
                      <Dropdown.Menu
                        className={`dropdown-menu dropdown-${idx.class1} dropmenu-${idx.class2}`}
                      >
...
<Dropdown.Item eventKey="2">Action 2</Dropdown.Item>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Ghost Button Dropdowns</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<div className="btn-group" key={Math.random()}>
    ...
    <Dropdown.Menu>
      ...
      <Row>
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>non-interactive dropdown items</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
 ...
 <Dropdown.Item><a className="dropdown-item" href="#">Something else here</a>
        ...
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Dropdown Headers</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
 ...
 <Dropdown.Item><a className="dropdown-item" href="#">Something else here</a>
        ...
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Dropdown Dividers</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
...
<Dropdown.Item className="dropdown-item" href="#">Separated link</Dropdown.Item>
        ...
        <Col xl={3}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Dropdown Menu Text</Card.Title>
              <div className="prism-toggle">
                <Button
                  variant="primary-light"
                  className="btn btn-sm"
