        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <Card.Body>
              ...
              <Toast
                className="toast-container position-fixed top-0 end-0 me-4 mt-4"
      ...
      <Toast.Body className="toast-body">
          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              ...
              <Toast
                className="toast align-items-center text-bg-info border-0 fade show mb-4"
                show={showF}
              >
                <div className="d-flex">
                  <Toast.Body className=" text-fixed-white">
            ...
            <Collapse in={open2} className="card-body">
              <pre>
                <code>{` <Toast className="toast align-items-center text-bg-primary border-0 fade show mb-4"  show={showC}>
<div className="d-flex">
<Toast.Body className=" text-fixed-white" >
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <Collapse in={open3} className="card-body">
              <pre>
                <code>{`<Toast show={showA} onClose={toggleShowA} className="toast show"
 ...
 role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
  ...
  <Toast.Body> Hello, world! This is a toast message.</Toast.Body>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Translucent</Card.Title>
              <div className="prism-toggle">
                <Button
  ...
  onClick={toggleShowJ}>Close</Button>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Color Variants Live</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              ...
              <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                ...
                <Toast
                  id="secondaryToast"
                  className="toast colored-toast bg-secondary-transparent"
                  role="alert"
                  aria-live="assertive"
                  aria-atomic="true"
                ...
                <Toast
                  id="warningToast"
                  className="toast colored-toast bg-warning-transparent"
                  role="alert"
                  aria-live="assertive"
                ...
                <Toast
                  id="infoToast"
                  className="toast colored-toast bg-info-transparent"
                  role="alert"
                  aria-live="assertive"
                ...
                <Toast
                  id="dangerToast"
                  className="toast colored-toast bg-danger-transparent"
                  role="alert"
                  aria-live="assertive"
            ...
            <Collapse in={open7} className="card-body">
              <pre>
                <code>{`<Toast id="primaryToast" bg="primary-transparent" className="toast colored-toast" 
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Solid Background Toasts</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              ...
              <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                <Toast
                  ...
                  className="toast colored-toast bg-primary text-fixed-white"
                ...
                <Toast
                  ...
                  className="toast colored-toast bg-secondary text-fixed-white"
                ...
                <Toast
                  ...
                  className="toast colored-toast bg-warning text-fixed-white"
                ...
                <Toast
                  id="solid-infoToast"
                  className="toast colored-toast bg-info text-fixed-white"
                ...
                <Toast
                  ...
                  className="toast colored-toast bg-success text-fixed-white"
                  onClose={() => setShow11(false)}
                  show={show11}
                  delay={3000}
                  autohide
                >
                ...
                <Toast
                  ...
                  className="toast colored-toast bg-danger text-fixed-white"
                  onClose={() => setShow12(false)}
                  show={show12}
                  delay={3000}
                  autohide
                >
            ...
            <Collapse in={open8} className="card-body">
              <pre>
                <code>{`  <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Toast Placements</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open9} className="">
              <pre>
                <code>{` <ToastContainer  className="toast-container position-fixed top-0 start-0 p-3">
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Aligning Toast Using Flexbox</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open10} className="">
              <pre>
                <code>{` <Toast show={showK} onClose={toggleShowK} className="toast fade show shadow-lg">
  <Toast.Header className="text-default">
