...
export const DefaultButtons: Default[] = [
...
export const LightButtons: Light[] = [
...
export const GradientButtons: Gradient[] = [
...
export const ColoredButtons: Colored[] = [
  { id: 1, class: 'primary' },
...
export const LabelButtons: Label[] = [
