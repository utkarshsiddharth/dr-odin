        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Headings H tags</Card.Title>
            ...
            <Collapse in={open1} className="card-body">
              <pre>
                <code>{`<h1 className="mb-3">h1. Bootstrap heading</h1>
<h2 className="mb-3">h2. Bootstrap heading</h2>
<h3 className="mb-3">h3. Bootstrap heading</h3>
<h4 className="mb-3">h4. Bootstrap heading</h4>
<h5 className="mb-3">h5. Bootstrap heading</h5>
<h6 className="mb-0">h6. Bootstrap heading</h6>`}</code>
              </pre>
            </Collapse>
          </Card>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Heading Class Names</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open2} className="card-body">
              <pre>
                <code>{`<p className="h1 mb-3">h1. Bootstrap heading</p>
<p className="h2 mb-3">h2. Bootstrap heading</p>
<p className="h3 mb-3">h3. Bootstrap heading</p>
<p className="h4 mb-3">h4. Bootstrap heading</p>
<p className="h5 mb-3">h5. Bootstrap heading</p>
<p className="h6 mb-0">h6. Bootstrap heading</p>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open3} className="card-body">
              <pre>
                <code>{`<h1 className="display-1">Display 1</h1>
 <h1 className="display-2">Display 2</h1>
 <h1 className="display-3">Display 3</h1>
 <h1 className="display-4">Display 4</h1>
 <h1 className="display-5">Display 5</h1>
 <h1 className="display-6">Display 6</h1>`}</code>
          ...
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Customizing headings</Card.Title>
              <div className="prism-toggle">
                <Button
...
<small className="text-muted">With faded secondary text</small>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open5} className="card-body">
              <pre>
                <code>{`<p>You can use the mark tag to <mark>highlight</mark> text.</p>
 ...
 <p className="mb-0"><em>This line rendered as italicized text.</em></p>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open6} className="card-body">
              <pre>
                <code>{`<p className="fs-1 mb-2">.fs-1 text</p>
<p className="fs-2 mb-2">.fs-2 text</p>
<p className="fs-3 mb-2">.fs-3 text</p>
<p className="fs-4 mb-2">.fs-4 text</p>
<p className="fs-5 mb-2">.fs-5 text</p>
<p className="fs-6 mb-0">.fs-6 text</p>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Lead Paragraph</Card.Title>
              <div className="prism-toggle">
                <Button
  ...
  If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Left Aligned</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open8} className="card-body">
              <pre>
                <code>{` <figure className="blockquote-container">
<blockquote className="blockquote mb-2">
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open9} className="card-body">
              <pre>
                <code>{` <figure className="blockquote-container text-end">
 <blockquote className="blockquote mb-2">
     <h6>The greatest glory in living lies not in never falling, but in rising every time we fall.</h6>
 </blockquote>
 <figcaption className="blockquote-footer mt-0 mb-0 text-muted op-7"><cite title="Source Title">Nelson Mandela</cite>
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className=" justify-content-between">
              <Card.Title>Primary Blockquote</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open10} className="card-body">
              <pre>
                <code>{`<blockquote className="blockquote custom-blockquote primary mb-0 text-center">
...
<span className="quote-icon"><i className="ri-information-line"></i></span></blockquote>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
        <div className="col-xl-4">
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Secondary Blockquote</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open11} className="card-body">
              <pre>
                <code>{`<blockquote className="blockquote custom-blockquote secondary mb-0 text-center">
<h6>The future belongs to those who believe in the beauty of their dreams..</h6>
<footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
<span className="quote-icon"><i className="ri-information-line"></i></span>
        ...
        <div className="col-xl-4">
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Warning Blockquote</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open12} className="card-body">
              <pre>
                <code>{` <blockquote className="blockquote custom-blockquote warning mb-0 text-center">
<h6>The future belongs to those who believe in the beauty of their dreams..</h6>
<footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
<span className="quote-icon"><i className="ri-information-line"></i></span>
 </blockquote>`}</code>
        ...
        <div className="col-xl-4">
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Success Blockquote</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open13} className="card-body">
              <pre>
                <code>{`<blockquote className="blockquote custom-blockquote success mb-0 text-center">
<h6>The future belongs to those who believe in the beauty of their dreams..</h6>
<footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
<span className="quote-icon"><i className="ri-information-line"></i></span>
</blockquote>`}</code>
        ...
        <div className="col-xl-4">
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Info Blockquote</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open14} className="card-body">
              <pre>
                <code>{`<blockquote className="blockquote custom-blockquote info mb-0 text-center">
<h6>The future belongs to those who believe in the beauty of their dreams..</h6>
<footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
<span className="quote-icon"><i className="ri-information-line"></i></span>
</blockquote>`}</code>
        ...
        <Col className="col-xl-4">
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Danger Blockquote</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open15} className="card-body">
              <pre>
                <code>{` <blockquote className="blockquote custom-blockquote danger mb-0 text-center">
<h6>The future belongs to those who believe in the beauty of their dreams..</h6>
<footer className="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0">Someone famous as <cite title="Source Title">-Eleanor Roosevelt</cite></footer>
<span className="quote-icon"><i className="ri-information-line"></i></span>
</blockquote>`}</code>
...
<dd className="col-sm-9 mb-0">
    <dl className="row mb-0">
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>List Unstyled</Card.Title>
              <div className="prism-toggle">
                <Button
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Card.Footer className="border-top-0">
              <Collapse in={open18} className="">
                <pre>
                  <code>{`<p><abbr title="attribute">attr</abbr></p>
 <p className="mb-0"><abbr title="HyperText Markup Language" className="initialism">HTML</abbr></p>`}</code>
                </pre>
              </Collapse>
            </Card.Footer>
          </Card>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>List inline</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open19} className="card-body">
              <pre>
                <code>{`<ul className="list-inline mb-0">
<li className="list-inline-item">This is a list item.</li>
<li className="list-inline-item">And another one.</li>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open20} className="card-body">
              <pre>
                <code>{`<p className="mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
...
<hr className="border-primary border-3 opacity-75"/>`}</code>
              </pre>
            </Collapse>
          </Card>
        </Col>
...
<p className="text-capitalize mb-0">CapiTaliZed text.</p>`}</code>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Text decoration</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open22} className="card-body">
              <pre>
                <code>{`<p className="text-decoration-underline">This text has a line underneath it.
 </p>
     ...
     removed
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Font weight and italics</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open23} className="card-body">
              <pre>
                <code>{`<p className="fw-bold">Bold text.</p>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open24} className="card-body">
              <pre>
                <code>{`<p className="lh-1">This is a long paragraph written to show how the line-height of
an
...
our utility API.
      ...
      <Row>
        <div className="col-xl-3">
          <Card className="custom-card">
            <div className="card-header justify-content-between">
              <Card.Title>Monospace</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open25} className="card-body">
              <pre>
                <code>{`<p className="font-monospace mb-0">This is in monospace</p>`}</code>
              </pre>
            </Collapse>
          </Card>
        </div>
        <div className="col-xl-3">
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Reset color</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open26} className="card-body">
              <pre>
                <code>{` <p className="text-muted mb-0">
Muted text with a <a href="#" className="text-reset text-decoration-underline text-dark">reset link</a>.
        ...
        <div className="col-xl-3">
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Visible text</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open27} className="card-body">
              <pre>
                <code>{`<p className="visible mb-0">This is visible text</p>`}</code>
              </pre>
            </Collapse>
          </Card>
        </div>
        <div className="col-xl-3">
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Invisible text</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open28} className="card-body">
              <pre>
                <code>{`<p className="invisible mb-0">This is invisible text</p>`}</code>
              </pre>
            </Collapse>
          </Card>
        </div>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open29} className="card-body">
              <pre>
                <code>{`<p className="text-start">Start aligned text on all viewport sizes.</p>
...
<p className="text-xl-start">Start aligned text on viewports sized XL (extra-large)
    ...
    wider.</p>`}</code>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Text wrapping and overflow</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open30} className="card-body">
              <pre>
                <code>{`<div className="badge bg-primary text-wrap mb-3" style={{width: 6}}>
 This text should wrap.
 </div>
 ...
 This text should overflow the parent.
          ...
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Word break</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open31} className="card-body">
              <pre>
                <code>{` <p className="text-break mb-0">
mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm
 </p>`}</code>
              </pre>
            </Collapse>
