          ...
          <Card className="custom-card">
            ...
            <Card.Body>
              {Colorspinner.map((idx) => (
                <div
                  className={`spinner-border text-${idx.color}`}
                  role="status"
                  key={Math.random()}
                >
                  <span className="visually-hidden">Loading...</span>
            ...
            <Collapse in={open2} className="card-body">
              <pre>
                <code>{`<div className="spinner-border text-secondary" role="status">
  <span className="visually-hidden">Loading...</span>
</div>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open3} className="card-body">
              <pre>
                <code>{`<div className="spinner-grow" role="status">
<span className="visually-hidden">Loading...</span>
</div>`}</code>
              </pre>
            </Collapse>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Card.Body>
              {Colorspinner.map((idx) => (
                <div
                  className={`spinner-grow me-1 text-${idx.color}`}
                  role="status"
                  key={Math.random()}
                >
                  <span className="visually-hidden">Loading...</span>
            ...
            <Collapse in={open4} className="card-body">
              <pre>
                <code>{` <div className="spinner-grow text-secondary" role="status">
<span className="visually-hidden">Loading...</span>
</div>
...
<span className="visually-hidden">Loading...</span>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Alignment Flex</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open5} className="card-body">
              <pre>
                <code>{` <div className="d-flex justify-content-center mb-4">
<div className="spinner-border" role="status">
    <span className="visually-hidden">Loading...</span>
</div>
 </div>
...
<div className="spinner-border ms-auto" role="status" aria-hidden="true"></div>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Alignment Float</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open6} className="card-body">
              <pre>
                <code>{`<div className="clearfix mb-4">
<div className="spinner-border float-end" role="status">
    <span className="visually-hidden">Loading...</span>
</div>
 </div>
    ...
    <span className="visually-hidden">Loading...</span>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Alignment Text center</Card.Title>
              <div className="prism-toggle">
                <Button
    ...
    <span className="visually-hidden">Loading...</span>
          ...
          <Card className="custom-card">
            ...
            <Collapse in={open8} className="card-body">
              <pre>
                <code>{` <div className="spinner-border spinner-border-sm me-4" role="status">
 <span className="visually-hidden">Loading...</span>
</div>
<div className="spinner-grow spinner-grow-sm me-4" role="status">
 <span className="visually-hidden">Loading...</span>
...
style={{ width: '3rem' , height: '3rem'}}
 ...
 <span className="visually-hidden">Loading...</span>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Alignment Margin</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open9} className="card-body">
              <pre>
                <code>{`<div className="spinner-border m-5" role="status">
<span className="visually-hidden">Loading...</span>
</div>`}</code>
              </pre>
            </Collapse>
