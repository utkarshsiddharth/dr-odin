          ...
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              ...
              <div className="btn-list">
                <Button variant="success" className="btn  btn-sm btn-wave me-0">
            ...
            <Card.Body>
              ...
              <p className="text-muted task-description">
                The current website design needs a refresh to improve user
                experience and enhance visual appeal. The goal is to create a
                modern and responsive design that aligns with the latest web
                design trends. The updated design should ensure seamless
                navigation, easy readability, and a cohesive visual identity.
              </p>
              <div className="fs-15 fw-semibold mb-2">Key tasks :</div>
              <div>
                <ul className="task-details-key-tasks mb-0">
                  <li>
                    Conducting a comprehensive analysis of the existing website
                    design.
                  </li>
                  <li>
                    Collaborating with the UI/UX team to develop wireframes and
                    mockups.
                  </li>
                  <li>Iteratively refining the design based on feedback.</li>
                  <li>
                    Implementing the finalized design changes using HTML, CSS,
                    and JavaScript.
                  </li>
                  <li>
                    Testing the website across different devices and browsers.
                  </li>
                  <li>
                    Conducting a final review to ensure all design elements are
            ...
            <Card.Footer className="card-footer">
              <div className="d-flex align-items-center justify-content-between gap-2 flex-wrap">
                ...
                <div className="task-details-progress">
                  <span className="d-block text-muted fs-12 mb-1">
                    Progress
                  </span>
                  <div className="d-flex align-items-center">
                    <ProgressBar
                      variant="primary"
                      now={70}
                      className="progress progress-xs progress-animate flex-fill me-2"
                    />
              ...
              <ul className="list-unstyled profile-timeline">
                <li>
                  <div>
                    ...
                    <p className="mb-2">
                      <b>You</b> Commented on <b>Work Process</b> in this task{" "}
                    ...
                    <p className="text-muted mb-0">
                      Task is important and need to be completed on time to meet
                      company work flow.
                    </p>
                  </div>
                </li>
                  ...
                  <div>
                    ...
                    <p className="text-muted mb-2">
                      <span className="text-default">
                        <b>Json Smith</b> reacted to the task &#128077;
                      </span>
                      .
                      <span className="float-end fs-11 text-muted">
                        18,Dec 2023 - 12:16
                    ...
                    <p className="text-muted mb-0">
                      ...
                      temporibus inventore ullam tempora eligendi libero sequi
                ...
                <li>
                  <div>
                    ...
                    <p className="mb-1">
                      <b>Json</b> Commented on Task post{" "}
                      <Link className="text-secondary" to="#">
                        <u>#UI Technologies</u>
                      </Link>
                      .
                    ...
                    <p className="text-muted">
                      Technology id developing rapidly keep up your work
                      &#128076;
                    </p>
                    <p className="profile-activity-media mb-0">
                      <Link to="#">
                ...
                <div className="flex-fill me-2">
                  <InputGroup>
                    ...
                    <Button
                      ...
                      className="btn  btn-wave waves-effect waves-light"
                      type="button"
                    >
              ...
              <div className="table-responsive">
                <Table className="table text-nowrap">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <span className="fw-semibold">Task Tags :</span>
                      </td>
                      <td>
                        <span className="badge bg-primary-transparent me-1">
                          UI/Ux
                        </span>
                        <span className="badge bg-primary-transparent me-1">
                          Designing
                    ...
                    <tr>
                      ...
                      <td>Ynex admin & dashboard template</td>
                    </tr>
                    <tr>
                      <td>
                    ...
                    <tr>
                      <td>
                        <span className="fw-semibold">Project Priority :</span>
                      </td>
                      <td>
          ...
          <Card className="custom-card overflow-hidden">
            <Card.Header className="justify-content-between">
              ...
              <div>
                ...
                >
                  <i className="ri-add-line me-1 align-middle"></i>Sub Task
                </Button>
              </div>
            </Card.Header>
            <Card.Body>
                  ...
                  <ListGroup.Item key={Math.random()}>
                    <div className="d-flex align-items-center">
                      <div className="me-2">
                        <input
                          id={idx.id}
                          className={`form-check-input form-checked-success form-checked-${
                            idx.class === "defaultChecked" ? "success" : ""
                          }`}
                          type="checkbox"
                          value=""
                ...
                {Attachmentdata.map((idx) => (
                  <ListGroup.Item key={Math.random()}>
                    <div className="d-flex align-items-center flex-wrap gap-2">
                      <div className="lh-1">
                        <span
                          className={`avatar avatar-rounded bg-light ${idx.class}`}
                        >
                          <img src={idx.src} alt="" />
                        </span>
                      </div>
