              ...
              <ul className="icons-list list-unstyled">
                {Bootstrapicons.map((idx) => (
                  <li className="icons-list-item" key={Math.random()}>
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>bi bi-{idx.text}</Tooltip>}
                    >
        ...
        <Col xl={12}>
          <Card className="custom-card">
            ...
            <Card.Body>
              ...
              <p className="mb-4">
                <code>&lt;i className="ri-ICON_NAME"&gt;&lt;/i&gt;</code>
              </p>
              <ul className="icons-list list-unstyled">
                {Remixicons.map((idx) => (
                  <li className="icons-list-item" key={Math.random()}>
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>ri-{idx.text}</Tooltip>}
                    >
              ...
              <ul className="icons-list list-unstyled">
                {Feathericons.map((idx) => (
                  <li className="icons-list-item" key={Math.random()}>
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>fe fe-{idx.text}</Tooltip>}
                    >
        ...
        <Col xl={12}>
          <Card className="custom-card">
            ...
            <Card.Body>
              ...
              <p className="mb-4">
                <code>&lt;i className="ti ti-ICON_NAME"&gt;&lt;/i&gt;</code>
              </p>
              <ul className="icons-list list-unstyled">
                {Tablericons.map((idx) => (
                  <li className="icons-list-item" key={Math.random()}>
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>ti ti-{idx.text}</Tooltip>}
                    >
        ...
        <Col xl={12}>
          <Card className="custom-card">
            ...
            <Card.Body>
              ...
              <p className="mb-4">
                <code>&lt;i className="las la-ICON_NAME"&gt;&lt;/i&gt;</code>
              </p>
              <ul className="icons-list list-unstyled">
                {LineAwesomeicons.map((idx) => (
                  <li className="icons-list-item" key={Math.random()}>
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>las la-{idx.text}</Tooltip>}
                    >
        ...
        <Col xl={12}>
          <Card className="custom-card">
            ...
            <Card.Body>
              ...
              <p className="mb-4">
                <code>&lt;i className="bx bx-ICON_NAME"&gt;&lt;/i&gt;</code>
              </p>
              <ul className="icons-list list-unstyled">
                {Boxicons.map((idx) => (
                  <li className="icons-list-item" key={Math.random()}>
                    <OverlayTrigger
                      placement="top"
                      overlay={<Tooltip>bx bx-{idx.text}</Tooltip>}
                    >
