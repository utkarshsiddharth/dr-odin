...
const Additionalcontent: FC<AdditionalcontentProps> = () => {
  return (
    <Fragment>
      <Pageheader title="more" heading="Utilities" active="more" />
      <Row>
          ...
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Display Inline</Card.Title>
                </Card.Header>
                <Card.Body>
                  <div className="d-inline p-2 bg-primary text-fixed-white rounded m-1">
                    d-inline
                  </div>
                  <div className="d-inline p-2 bg-primary-transparent text-primary rounded m-1">
                    d-inline
                  </div>
                </Card.Body>
              </Card>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>D-block</Card.Title>
                </Card.Header>
                <Card.Body>
                  <span className="d-block p-2 bg-secondary-transparent mb-1 rounded">
                    d-block
                  </span>
                  <span className="d-block p-2 bg-primary-transparent mb-1 rounded">
                    d-block
                  </span>
                  <span className="d-block p-2 bg-success-transparent mb-1 rounded">
                    d-block
                  </span>
                </Card.Body>
              </Card>
        ...
        <div className="col-xl-4">
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Float</Card.Title>
                </Card.Header>
                <Card.Body>
                  <div className="float-start p-2 bg-primary rounded text-fixed-white mb-2">
                    Float start
                  </div>
                  <br />
                  <div className="float-end p-2 bg-primary rounded text-fixed-white">
                    Float end
                  </div>
                  <br />
                  <div className="float-none p-2 bg-primary rounded text-fixed-white mt-4">
                    Don't float
                  </div>
                </Card.Body>
              </Card>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Float Responsive</Card.Title>
                </Card.Header>
                <Card.Body>
                  <div className="float-sm-start p-1 bg-light">Float sm</div>
                  <br />
                  <div className="float-md-end p-1 bg-light">Float md</div>
                  <br />
                  <div className="float-lg-start p-1 bg-light">Float lg</div>
                  <br />
                  <div className="float-xl-end p-1 bg-light">Float xl</div>
                </Card.Body>
              </Card>
            </Col>
          </Row>
        ...
        <div className="col-xl-4">
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Text selection</Card.Title>
                </Card.Header>
                <Card.Body>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Pointer events</Card.Title>
                </Card.Header>
                <Card.Body>
                  <p>
                    <Link
        ...
        <Col xl={6}>
          <Row>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Overflow</Card.Title>
                </Card.Header>
        ...
        <Col xl={6}>
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Vertical alignment With table cells</Card.Title>
                </Card.Header>
                <Card.Body>
        ...
        <Col xl={6}>
          <Row>
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Opacity</Card.Title>
                </Card.Header>
                <Card.Body className=" d-sm-flex">
                  <div className="opacity-100 p-3 m-2 bg-primary text-fixed-white fw-bold rounded">
                    100%
                  </div>
                  <div className="opacity-75 p-3 m-2 bg-primary text-fixed-white fw-bold rounded">
                    75%
                  </div>
                  <div className="opacity-50 p-3 m-2 bg-primary text-fixed-white fw-bold rounded">
                    50%
                  </div>
                  <div className="opacity-25 p-3 m-2 bg-primary text-fixed-white fw-bold rounded">
                    25%
                  </div>
                </Card.Body>
              </Card>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Horizontal centering</Card.Title>
                </Card.Header>
                <Card.Body>
                  <div
                    className="mx-auto"
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Relative to the parent</Card.Title>
            </Card.Header>
            <Card.Body>
              <div className="mb-5">
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>
                You can also use{" "}
                <span className="text-danger"> max-width: 100%;</span> and{" "}
                <span className="text-danger">max-height: 100%;</span> utilities
                as needed.
              </Card.Title>
            </Card.Header>
            <Card.Body>
              <img
                className="bd-placeholder-img mw-100 card-img"
                src={media7}
                alt="..."
              />
              <div
