        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Basic Tables</Card.Title>
                ...
                <Table className="table text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>+1234-12340</td>
                      <td>
                        <Badge bg="outline-primary" className="badge">
                          Completed
                        </Badge>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>+1523-12459</td>
                      <td>
                        <Badge bg="outline-warning" className="badge ">
                          Failed
                        </Badge>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>+1982-16234</td>
                      <td>
                        <Badge bg="outline-success" className="badge">
                          Successful
                        </Badge>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>+1526-10729</td>
                      <td>
                        <Badge bg="outline-secondary" className="badge">
                          Pending
                        </Badge>
                      </td>
                    </tr>
            ...
            <Collapse in={open1} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap">
<thead>
    <tr>
  <th scope="col">Name</th>
  <th scope="col">Created On</th>
...
<tbody>
  ...
  Pending</Badge></td>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Bordered Tables</Card.Title>
              <div className="prism-toggle">
                <Button
                      ...
                      <tr key={Math.random()}>
                        <th scope="row" key={Math.random()}>
                          <div className="d-flex align-items-center">
                            <span
                              className={`avatar avatar-xs me-2 ${idx.class1} avatar-rounded`}
                            >
            ...
            <Collapse in={open2} className="card-body">
              <pre>
                <code>{`   <Table className="table text-nowrap table-bordered">
<thead>
 <tr>
     <th scope="col">User</th>
     <th scope="col">Status</th>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Bordered Primary</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open3} className="card-body">
              <pre>
                <code>{`<Table bordered  className="table text-nowrap  border-primary">
 <thead>
     <tr>
         <th scope="col">Order</th>
         <th scope="col">Date</th>
 ...
 <tbody>
     ...
     <tr key={Math.random()}>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Bordered Success</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open4} className="card-body">
              <pre>
                <code>{`<Table bordered className="table text-nowrap border-success">
<thead>
    <tr>
        <th scope="col">Order</th>
        <th scope="col">Date</th>
...
<tbody>
    ...
    <tr key={Math.random()}>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Bordered warning</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <div className="table-responsive">
                <Table
                  bordered
                  className="table text-nowrap table-bordered border-warning"
                >
                  <thead>
                    <tr>
                      <th scope="col">Order</th>
            ...
            <Collapse in={open5} className="card-body">
              <pre>
                <code>{`<Table bordered className="table text-nowrap table-bordered border-warning">
<thead>
    <tr>
        <th scope="col">Order</th>
        <th scope="col">Date</th>
    ...
    <tr key={Math.random()}>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Table Without Borders</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open6} className="card-body">
              <pre>
                <code>{`<Table borderless className="text-nowrap">
 <thead>
     <tr>
         <th scope="col">User Name</th>
         <th scope="col">Transaction Id</th>
 ...
 <tbody>
     ...
     <tr>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Table Group Divideres</Card.Title>
              <div className="prism-toggle">
                <Button
                ...
                <Table className="table text-nowrap">
                  ...
                  <tbody className="table-group-divider">
                    <tr>
                      ...
                      <td>
                        <Link to="#" className="text-success">
                          24.23%<i className="ri-arrow-up-fill ms-1"></i>
                        </Link>
                      </td>
                      <td>250/1786</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <Link to="#" className="text-danger">
                          12.45%<i className="ri-arrow-down-fill ms-1"></i>
                        </Link>
                      </td>
                      <td>123/985</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <Link to="#" className="text-success">
                          06.64%<i className="ri-arrow-up-fill ms-1"></i>
                        </Link>
                      </td>
                      <td>124/232</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <Link to="#" className="text-success">
                          14.42%<i className="ri-arrow-up-fill ms-1"></i>
                        </Link>
                      </td>
                      <td>192/2456</td>
                    </tr>
        ...
        <Col xl={6}>
          <Card className="custom-card">
                    ...
                    {Table5data.map((idx) => (
                      <tr key={Math.random()}>
                        ...
                        <td>
                          <Button
                            variant="success"
                            className="btn btn-sm btn-wave"
                          >
                            <i className="ri-download-2-line align-middle me-2 d-inline-block"></i>
                            Download
                          </Button>
                        </td>
                      </tr>
            ...
            <Collapse in={open8} className="card-body">
              <pre>
                <code>{` <Table striped className="table text-nowrap table-striped">
<thead>
    <tr>
     <th scope="col">ID</th>
     <th scope="col">Date</th>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open9} className="card-body">
              <pre>
                <code>{`<Table striped="columns" className="table text-nowrap">
<thead>
    <tr>
        <th scope="col">ID</th>
        <th scope="col">Date</th>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <Collapse in={open10} className="card-body">
              <pre>
                <code>{`<Table variant='primary' className="table text-nowrap">
<thead>
    <tr>
        <th scope="col">#</th>
        <th scope="col">First</th>
...
<tbody>
    ...
    <tr key={Math.random()}>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Secondary Table</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open11} className="card-body">
              <pre>
                <code>{`<Table variant='secondary' className="table text-nowrap">
 <thead>
     <tr>
         <th scope="col">#</th>
         <th scope="col">First</th>
 ...
 <tbody>
     ...
     <tr>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Warning Table</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open12} className="card-body">
              <pre>
                <code>{`<Table variant='warning' className="table text-nowrap">
 <thead>
     <tr>
         <th scope="col">#</th>
         <th scope="col">First</th>
 ...
 <tbody>
     ...
     <tr>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Danger Table</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <div className="table-responsive">
                <Table
                  variant="danger"
                  className="table text-nowrap table-danger"
                >
                  <thead>
                    <tr>
                      <th scope="col">#</th>
            ...
            <Collapse in={open13} className="card-body">
              <pre>
                <code>{`<Table variant='danger' className="table text-nowrap">
 <thead>
     <tr>
         <th scope="col">#</th>
         <th scope="col">First</th>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            ...
            <Collapse in={open14} className="card-body">
              <pre>
                <code>{`<Table variant='dark' className="table text-nowrap">
 <thead>
     <tr>
         <th scope="col">#</th>
         <th scope="col">First</th>
 ...
 <tbody>
     ...
     <tr>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Success Table With Striped Rows</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Card.Body>
              <div className="table-responsive">
                <Table
                  striped
                  variant="success"
                  className="table text-nowrap table-success table-striped"
                >
                  <thead>
                    <tr>
                      <th scope="col">#</th>
            ...
            <Collapse in={open15} className="card-body">
              <pre>
                <code>{`<Table striped variant='success' className="table text-nowrap">
 <thead>
     <tr>
         <th scope="col">#</th>
         <th scope="col">First</th>
        ...
        <Col xl={6}>
          <Card className="custom-card">
                ...
                <Table hover className="text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="badge bg-dark-transparent">
                          Electronics
                        </span>
                      </td>
                      <td>
            ...
            <Collapse in={open16} className="card-body">
              <pre>
                <code>{`  <Table hover className="text-nowrap">
 <thead>
     <tr>
         <th scope="col">Product Manager</th>
         <th scope="col">Category</th>
 ...
 <tbody>
     <tr>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Hoverable rows With striped rows</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open17} className="card-body">
              <pre>
                <code>{`<Table striped hover className="table text-nowrap">
 <thead>
 <tr>
     <th scope="col">Invoice</th>
     <th scope="col">Customer</th>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open18} className="card-body">
              <pre>
                <code>{` <Table className="table text-nowrap">
 <thead  className="table-primary">
     <tr>
 ...
 <tbody>
     ...
     <tr key={Math.random()}>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Table Head warning</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open19} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap">
<thead className="table-warning">
    <tr>
...
<tbody>
    ...
    <Button variant={idx.color} className="btn btn-sm">{idx.btn}</Button>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Table Head Success</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open20} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap">
<thead className="table-warning">
    <tr>
...
<tbody>
    ...
    <Button variant={idx.color} className="btn btn-sm">{idx.btn}</Button>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Table Head Info</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open21} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap">
<thead className="table-info">
    <tr>
...
<tbody>
    ...
    <Button variant={idx.color} className="btn btn-sm">{idx.btn}</Button>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Table Head Secondary</Card.Title>
              <div className="prism-toggle">
                <Button
...
<tbody>
    ...
    <Button variant={idx.color} className="btn btn-sm">{idx.btn}</Button>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Table Head Danger</Card.Title>
              <div className="prism-toggle">
                <Button
            ...
            <Collapse in={open23} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap">
<thead className="table-danger">
    <tr>
    ...
    <Button variant={idx.color} className="btn btn-sm">{idx.btn}</Button>
      ...
      <Row>
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Table Foot</Card.Title>
              <div className="prism-toggle">
                <Button
                ...
                <Table className="table text-nowrap">
                  ...
                  <tfoot className="table-primary">
                    <tr>
                      ...
                      <td>558</td>
                      <td>
                        <span className="badge bg-primary">56%</span>
                      </td>
                    </tr>
                  </tfoot>
                </Table>
            ...
            <Collapse in={open24} className="card-body">
              <pre>
                <code>{` <Table className="table text-nowrap">
<thead className="table-primary">
    <tr>
...
<tfoot className="table-primary">
    <tr>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Table With Caption</Card.Title>
              <div className="prism-toggle">
                <Button
                  onClick={() => setOpen25(!open25)}
                  variant="primary-light"
                  className="btn btn-sm"
                  aria-controls="example-collapse-text"
                  aria-expanded={open25}
                >
                  Show Code
                  <i className="ri-code-line ms-2 d-inline-block align-middle"></i>
                </Button>
                ...
                <Table className="table text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>United States</td>
                      <td>
                        2012<i className="ri-medal-line mx-2"></i>
                      </td>
                      <td>1823</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        1012<i className="ri-medal-line mx-2"></i>
                      </td>
                      <td>992</td>
                    </tr>
                    <tr>
                      ...
                      <td>Germany</td>
                      <td>
                        914<i className="ri-medal-line mx-2"></i>
                      </td>
                      <td>875</td>
                    </tr>
                  </tbody>
            ...
            <Collapse in={open25} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap">
 <caption>Top 3 Countries</caption>
 <thead>
 ...
 <tbody>
     ...
     <tr>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Table With Top Caption</Card.Title>
              <div className="prism-toggle">
                <Button
                  onClick={() => setOpen26(!open26)}
                  variant="primary-light"
                  className="btn btn-sm"
                  aria-controls="example-collapse-text"
                  aria-expanded={open26}
                >
                  Show Code
                  <i className="ri-code-line ms-2 d-inline-block align-middle"></i>
                </Button>
            ...
            <Collapse in={open26} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap caption-top">
<caption>Top IT Companies</caption>
<thead>
    <tr>
        <th scope="col">S.No</th>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              ...
              <div className="prism-toggle">
                <Button
                  onClick={() => setOpen27(!open27)}
                  variant="primary-light"
                  className="btn btn-sm"
                  aria-controls="example-collapse-text"
                  aria-expanded={open27}
                >
                  Show Code
                  <i className="ri-code-line ms-2 d-inline-block align-middle"></i>
                </Button>
            ...
            <Collapse in={open27} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap">
<thead>
    <tr>
...
<tbody>
    ...
    <tr>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Small Tables</Card.Title>
              <div className="prism-toggle">
                <Button
                  onClick={() => setOpen28(!open28)}
                  variant="primary-light"
                  className="btn btn-sm"
                  aria-controls="example-collapse-text"
                  aria-expanded={open28}
                >
                  Show Code
                  <i className="ri-code-line ms-2 d-inline-block align-middle"></i>
                </Button>
                  ...
                  <tbody>
                    {Table11data.map((idx) => (
                      <tr key={Math.random()}>
                        ...
                        <td>{idx.date}</td>
                        <td>
                          <Badge bg={idx.class} className="badge">
                            {idx.text}
                          </Badge>
                        </td>
                        <td>
            ...
            <Collapse in={open28} className="card-body">
              <pre>
                <code>{`<Table size="sm" className="table text-nowrap">
<thead>
    <tr>
        <th scope="col">Invoice</th>
        <th scope="col">Created Date</th>
    ...
    <tr key={Math.random()}>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Color variants tables</Card.Title>
              <div className="prism-toggle">
                <Button
                  onClick={() => setOpen29(!open29)}
                  variant="primary-light"
                  className="btn btn-sm"
                  aria-controls="example-collapse-text"
                  aria-expanded={open29}
                >
                  Show Code
                  <i className="ri-code-line ms-2 d-inline-block align-middle"></i>
                </Button>
            ...
            <Collapse in={open29} className="card-body">
              <pre>
                <code>{` <Table className="table text-nowrap">
<thead>
    <tr>
    ...
    <tr key={Math.random()} className={idx.class1}>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            ...
            <Collapse in={open30} className="card-body">
              <pre>
                <code>{`<Table striped bordered className="table text-nowrap">
 <thead>
     <tr>
         <th scope="col">#</th>
         <th scope="col">First</th>
     ...
     <tr>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Always responsive</Card.Title>
              <div className="prism-toggle">
                <Button
                  onClick={() => setOpen31(!open31)}
                  variant="primary-light"
                  className="btn btn-sm"
                  aria-controls="example-collapse-text"
                  aria-expanded={open31}
                >
                  Show Code
                  <i className="ri-code-line ms-2 d-inline-block align-middle"></i>
                </Button>
            ...
            <Collapse in={open31} className="card-body">
              <pre>
                <code>{`<Table className="table text-nowrap">
 <thead>
     <tr>
     ...
     <tr>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Vertical alignment</Card.Title>
              <div className="prism-toggle">
                <Button
                  onClick={() => setOpen32(!open32)}
                  variant="primary-light"
                  className="btn btn-sm"
                  aria-controls="example-collapse-text"
                  aria-expanded={open32}
                >
                  Show Code
                  <i className="ri-code-line ms-2 d-inline-block align-middle"></i>
                </Button>
                ...
                <Table className="table align-middle">
                  ...
                  <tbody>
                    {Table13data.map((idx) => (
                      <tr key={Math.random()} className={idx.class1}>
                        <td>
                          {idx.text1} <code>{idx.code1}</code> {idx.text2}
                        </td>
                        <td>
                          {idx.text1} <code>{idx.code1}</code> {idx.text2}
                        </td>
                        <td className={idx.class2}>
                          {idx.text3} <code>{idx.code2}</code> {idx.text4}
                        </td>
                        <td>
                          This here is some placeholder text, intended to take
                          up quite a bit of vertical space, to demonstrate how
            ...
            <Collapse in={open32} className="card-body">
              <pre>
                <code>{` <Table className="table align-middle">
<thead>
    <tr>
